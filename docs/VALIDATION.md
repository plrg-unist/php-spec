...
Canonical syntax equality ignores source positions (including `namespaceBraceLine`, `statementTerminatorLine` and `statementBodyLine`), ternary grouping, literal spelling/kind,
