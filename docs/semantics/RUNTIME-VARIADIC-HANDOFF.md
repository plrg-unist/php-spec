...
files and all951 modes. Start from the final full input manifest, preserving
all prior942/933/926 source and evidence identities.

REPORTING is request-global signed32; state/frame SILENCES retain source origins
and saved masks. Compiler100 preserves known results and effect roots; runtime101
reads deferred CVs before END, preserves owning references and conditionally
restores masks on END and frame cleanup independently of TODO. Unit/source and
pending close guards preserve arbitrary valid masks/values. General configuration,
handlers and configured fatal rendering remain open, despite the reviewed30719
profile. Reuse79/83/84/91/95/99 ownership, default-cache, type and cleanup interfaces.

Next preparation is `.tools/compiler7-callable-next/PLAN.md` and archive
56f4d18168b098e8b517e9b32bee5b9146acf05596e283e5808bb6a5f2608065:
16 native/16 lint/14 separate opcode contexts. Its later STARTUP.md and
...
current-source/full-syntax/fresh network-isolated offline checks remain mandatory.
Objects, exceptions, dynamic sources/callables, generators/Fibers, lifetime and
core intrinsics remain in the full goal; this checkpoint closes no family.
