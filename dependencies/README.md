...
| `vendor/libm-pow-source` | Selected unchanged glibc 2.39 files for Ubuntu `2.39-0ubuntu8.8` amd64 FMA power: arithmetic, tables, dispatch and licenses. Source evidence for a pure reference, never a native evaluator dependency. [Pin and operation graph](../docs/semantics/POWER-PROVENANCE.md). |
