...
IGNORED_META = {"startLine", "endLine", "startFilePos", "endFilePos", "startTokenPos",
                "endTokenPos", "kind", "rawValue", "docLabel", "docIndentation", "hasLeadingNewline", "namespaceBraceLine", "statementTerminatorLine", "statementBodyLine", "classKeywordLine", "parenthesizedConditional", "destructuringArrayKind", "listFirstHoleLine", "arrayFirstHoleLine", "concatExprLine", "cloneExprLine", "nullaryExprLine", "callableExprLine"}
