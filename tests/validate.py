...
IGNORED_META = {"startLine", "endLine", "startFilePos", "endFilePos", "startTokenPos",
                "endTokenPos", "kind", "rawValue", "docLabel", "docIndentation", "hasLeadingNewline", "namespaceBraceLine", "statementTerminatorLine", "statementBodyLine", "parenthesizedConditional", "destructuringArrayKind"}
