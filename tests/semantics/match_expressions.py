#!/usr/bin/env python3
"""Replay retained match expression sources against the checked CLI."""
...
CASES = json.loads((ROOT / 'tests/semantics/match_cases.json').read_text())
...
def run(match):
    ...
    assert selected, 'no match source controls selected'
