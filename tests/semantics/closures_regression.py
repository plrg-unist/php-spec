#!/usr/bin/env python3
"""Named and main static cells, return aliases and shared call ownership across closures."""
...
if __name__ == '__main__':
    raise SystemExit(0 if scope.main(CASES, 'closures-regression', Path(__file__)) else 1)
