...
PENDING = {'default-cache-before-type-failure': 'ordinary statement compilation', 'default-null-before-required': 'named, unpacked or reference call argument compilation', 'class-parameter': 'dependent function type, reference return or variadic activation', 'object-parameter': 'dependent function type, reference return or variadic activation', 'callable-parameter': 'dependent function type, reference return or variadic activation', 'iterable-parameter': 'dependent function type, reference return or variadic activation', 'intersection-parameter': 'dependent function type, reference return or variadic activation', 'class-return': 'dependent function type, reference return or variadic activation'}
