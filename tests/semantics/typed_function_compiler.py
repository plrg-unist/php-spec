...
PENDING = {'default-cache-before-type-failure': 'ordinary statement compilation', 'class-parameter': 'dependent function type or variadic activation', 'iterable-parameter': 'dependent function type or variadic activation', 'intersection-parameter': 'dependent function type or variadic activation', 'class-return': 'dependent function type or variadic activation'}
