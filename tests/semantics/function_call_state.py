...
SELECTION = [
    'calls3-active-surplus-shared-reference-owner',
    'calls3-saved-surplus-shared-reference-owner',
    'calls3-caller-held-shared-reference-owner',
    'calls3-earlier-argument-shared-reference-owner',
    'calls3-returned-local-singleton-reference-cow',
    'calls3-returned-global-shared-reference-cow',
    'iterator-error-1', 'argument-deferred-inner-key-call', 'fallback-0',
]
...
def main():
    ...
    out = Path(tempfile.mkdtemp(prefix='function-call-state-', dir=ROOT / '.tools'))
    ...
    (ROOT / 'coverage/semantics/function-call-state.json').write_text(json.dumps(report, indent=2))
    return True
