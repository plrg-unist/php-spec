#!/usr/bin/env python3
"""Replay retained clone sources against the checked CLI."""
...
CASES = json.loads((ROOT / 'tests/semantics/clone_cases.json').read_text())
...
def run(match):
    ...
    assert selected, 'no clone source cases selected'
