#!/usr/bin/env python3
"""Replay retained public method/constructor sources against the checked CLI."""
...
CASES = json.loads((ROOT / 'tests/semantics/method_runtime_cases.json').read_text())
...
def run(match):
    ...
    watched = [*modules, ROOT / 'spec/semantics/modules.json', Path(__file__),
               ROOT / 'tests/semantics/method_runtime_cases.json',
