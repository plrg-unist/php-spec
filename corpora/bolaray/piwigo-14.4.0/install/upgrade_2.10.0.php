...
foreach ($to_apply as $upgrade_id) {
    if ($upgrade_id >= 157) { // TODO change on each release (first task to run)
        break;
    }
    ...
    array_push(
        ...
        'description' => '[migration from 2.10.0 to '.PHPWG_VERSION.'] not applied', // TODO change on each release
        )
    );
}
