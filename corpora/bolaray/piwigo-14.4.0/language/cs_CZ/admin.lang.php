...
$lang['Create a sub-album of "%s"'] = 'Vytvořit podalba "%s"';
...
$lang['%d in whole branch'] = '%d v celé větvi';
$lang['%d including sub-albums'] = '%d včetně podalb';
$lang['Activate button "%s"'] = 'Aktivace tlačítka "%s"';
$lang['During upload, if Piwigo detects the photo already exists, associate the existing photo to the destination album, without duplicating file'] = 'Pokud Piwigo během nahrávání zjistí, že fotografie již existuje, přiřadí ji k cílovému albu, aniž by došlo k duplikaci souboru.';
$lang['All admins'] = 'Všichni správci';
$lang['Allow comments for sub-albums'] = 'Povolit komentáře pro podalba';
$lang['Authorize comments'] = 'Autorizovat komentáře';
$lang['Comments allowed for sub-albums'] = 'Komentáře povolené pro podalba';
$lang['Comments disallowed for sub-albums'] = 'Komentáře zakázané pro podalba';
$lang['Created'] = 'Vytvořeno';
$lang['Detect and avoid duplicates during upload'] = 'Detekce a zamezení duplicit při nahrávání';
$lang['Disallow comments for sub-albums'] = 'Zakázat komentáře pro podalba';
$lang['Locked album'] = 'Uzamčené album';
$lang['Modified'] = 'Upraveno';
$lang['Only admins in a specific group'] = 'Pouze správci v určité skupině';
$lang['Put at the root'] = 'Vložit do kořene';
