...
$lang['Each email sent will contain its own automatic authentication key on links, valid for %s.'] = 'هر ایمیلی که فرستاده می‌شود، به طور خودکار دارای یک کلید احراز هویت مخصوص بوده که برای %s معتبر است.';
$lang['Edit user'] = 'ویرایش کاربر';
$lang['For security reason, authentication keys do not work for administrators.'] = 'به دلایل امنیتی، کلیدهای احراز هویت برای مدیران فعال نیست.';
$lang['No recipient selected'] = 'دریافت کننده‌ای انتخاب نشده است';
$lang['No user is permitted to see this private album'] = 'هیچ کاربری اجازه‌ی دیدن این آلبوم شخصی را ندارد';
$lang['Recipients'] = 'دریافت کنندگان';
