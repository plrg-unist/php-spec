...
$lang['Create a first album'] = '建立第一本相簿';
$lang['Dashboard'] = '統計資訊';
$lang['Delete %d orphan photos'] = '刪除 %d 張不屬於任何相簿的照片';
$lang['Delete album'] = '刪除相簿';
$lang['Delete album "%s" and its %d sub-albums.'] = '刪除相簿「%s」以及其下的 %d 本子相簿。';
$lang['Delete album "%s".'] = '刪除相簿「%s」。';
$lang['Delete orphan tags ?'] = '刪除沒有用到的標籤嗎？';
$lang['Delete tag "%s"?'] = '刪除「%s」這個標籤嗎？';
$lang['Delete tags \{%s\}?'] = '刪除 \{%s\} 這些標籤嗎？';
$lang['Delete them'] = '刪除';
$lang['Deletion in progress'] = '刪除作業進行中';
$lang['Display'] = '顯示';
$lang['Are you sure you want to delete this site?'] = '確定要刪除這個網站嗎？';
$lang['Are you sure you want to delete this theme?'] = '確定要刪除這個佈景主題嗎？';
$lang['Are you sure you want to delete this?'] = '確定要刪除嗎？';
$lang['Are you sure you want to install the plugin "%s"?'] = '確定要安裝「%s」這個外掛程式嗎？';
$lang['Are you sure you want to restore the plugin "%s"?'] = '確定要復原「%s」這個外掛程式嗎？';
$lang['Are you sure you want to restore this plugin?'] = '確定要復原這個外掛程式嗎？';
$lang['Are you sure you want to restore to default settings?'] = '確定要恢復到預設的設定嗎？';
$lang['At least 2 selected tags are needed to merge'] = '至少需要選定 2 個以上的標籤才能進行合併';
$lang['Average last 12 months'] = '過去 12 個月的平均值';
$lang['Cache'] = '快取';
$lang['Choose which tag to merge these tags into'] = '選擇要將這個標籤合併為哪個標籤';
$lang['Clear Selection'] = '取消選定';
$lang['Compare mode'] = '比較模式';
$lang['Compute %d missing checksums'] = '計算 %d 個不存在的檢查碼';
$lang['Confirm deletion'] = '確認刪除';
$lang[' (copy %s)'] = '（複製 %s）';
$lang[' (copy)'] = '（複製）';
$lang['%d Activities'] = '%d 項活動';
$lang['%d Activity'] = '%d 項活動';
$lang['%d checksums were added'] = '已加入 %d 個檢查碼';
$lang['%d photos'] = '%d 張照片';
$lang['%d sub-albums'] = '%d 個子相簿';
$lang['%s other tags available..'] = '還有其他 %s 個標籤';
$lang['... or hide this link'] = '... 或是隱藏此連結';
$lang['Activity peak in the last weeks'] = '過去幾個星期的活躍程度';
$lang['Album search tool'] = '相簿搜尋工具';
$lang['Are you sure you want to delete all sizes?'] = '確定要刪除所有尺寸的照片嗎？';
$lang['Are you sure you want to delete group "%s"?'] = '確定要刪除「%s」這個群組嗎？';
$lang['Are you sure you want to delete the language "%s"?'] = '確定要刪除「%s」這個語言嗎？';
$lang['Are you sure you want to delete the plugin "%s"?'] = '確定要刪除「%s」這個外掛程式嗎？';
$lang['Are you sure you want to delete the ratings of the user "%s"?'] = '確定要刪除使用者「%s」的所有評價嗎？';
$lang['Are you sure you want to delete the theme "%s"?'] = '確定要刪除「%s」這個佈景主題嗎？';
$lang['Are you sure you want to delete the user "%s"?'] = '確定要刪除「%s」這位使用者嗎？';
$lang['<b>1</b> album found'] = '找到 <b>1</b> 本相簿';
$lang['%s GB used'] = '使用了 %s GB';
$lang['%s MB used'] = '使用了 %s MB';
$lang['<b>%d</b> albums found'] = '找到 <b>%d</b> 本相簿';
$lang['<b>%d</b> tag found'] = '找到 <b>%d</b> 個標籤';
$lang['<b>%d</b> tag selected'] = '選了 <b>%d</b> 個標籤';
$lang['<b>%d</b> tags found'] = '找到 <b>%d</b> 個標籤';
$lang['Tag Manager'] = '標籤管理員';
$lang['Tag(s) \{%s1\} succesfully merged into "%s2"'] = '成功將標籤 \{%s1\} 合併至「%s2」';
$lang['Tags \{%s\} succesfully deleted'] = '成功刪除 \{%s\} 等標籤';
$lang['The %d tags on this page are selected'] = '已選擇本頁中的 %d 個標籤';
$lang['The other tags will be removed'] = '已刪除其他的標籤';
$lang['This is already the default theme'] = '這個佈景主題已經是預設主題了';
$lang['Time has come to update your Piwigo with version %s, go to %s'] = '是時候將您的 Piwigo 升級到 %s 了，請前往 %s';
$lang['Unset as group for new users'] = '取消將新增使用者加入此群組';
$lang['User "%s" dissociated from this group'] = '斷開使用者「%s」與此群組的關聯';
$lang['User associated'] = '相關聯的使用者';
$lang['Videos'] = '影片';
$lang['Visit'] = '瀏覽';
$lang['Welcome!'] = '歡迎！';
$lang['With no checksum'] = '不含檢查碼';
$lang['Y Repeat'] = 'Y 軸方向重覆';
$lang['Yes, I am sure'] = '是的，我確定';
$lang['Yes, delete'] = '是的，請刪除';
$lang['You don\'t have access to this photo'] = '您沒有存取這張照片的權限';
$lang['You have %d orphan tags %s'] = '您有 %d 個沒用到的標籤 %s';
$lang['You have %s inactive plugins'] = '您有 %s 未啟用的外掛程式';
$lang['Set as default'] = '設定為預設值';
$lang['Set as group for new users'] = '設定為新增使用者時的預設群組';
$lang['Share / Send your photos directly from your Mac Os X (10.10 and following) to Piwigo'] = '直接從 macOS（需 10.10 以上的版本）分享/寄送照片到 Piwigo';
$lang['Show inactive plugins'] = '顯示非使用中的外掛程式';
$lang['Showing %s users out of %s'] = '顯示 %s 個使用者（全部有 %s 個）';
$lang['Some checksums are missing.'] = '找不到某些檢查碼。';
$lang['Storage'] = '儲存空間';
$lang['Storage used'] = '已使用的儲存空間';
$lang['Synchronization in progress'] = '正在同步中';
$lang['Tag "%s" created'] = '已建立「%s」標籤';
$lang['Tag "%s" succesfully deleted'] = '已成功刪除「%s」標籤';
$lang['Tag "%s1" renamed in "%s2"'] = '已將「%s1」標籤更名為「%s2」';
$lang['Page Visited'] = '被瀏覽的次數';
$lang['Page Visited in %s'] = '於 %s 被瀏覽的次數';
$lang['Piwigo %s is available, please update'] = 'Piwigo %s 版已發行，請更新';
$lang['Piwigo Remote Sync is able to upload a whole folder hierarchy. If you run it again, only new photos will be uploaded.'] = 'Piwigo Remote Sync 遠端同步功能可以上傳完整的目錄結構。如果您重覆執行，只有新的照片會上傳。';
$lang['Piwigo requires an album to add photos.'] = 'Piwigo 需要先有相簿才能新增照片。';
$lang['Please upgrade your PHP version before any update.'] = '在更新之前，請先升級您的 PHP 版本。';
$lang['Portraits'] = '肖像';
$lang['Posted %s'] = '張貼了 %s';
$lang['Promote mobile app on mobile devices'] = '在行動裝置上推薦 Piwigo 的行動 app';
$lang['Recipients'] = '收件人';
$lang['Refresh thumbnail'] = '重新整理縮圖';
$lang['Requires PHP %s'] = '必須要有 PHP %s';
$lang['Review'] = '審核';
$lang['Running on an up-to-date Piwigo is important for security.'] = '以安全性來說，執行最新版的 Piwigo 是相當重要的。';
$lang['Search albums'] = '搜尋相簿';
$lang['Search tips'] = '搜尋的提示';
$lang['Select'] = '選擇';
$lang['Select all %d tags'] = '選擇所有 %d 個標籤';
$lang['Select tags'] = '選擇標籤';
$lang['Selection mode'] = '選擇模式';
$lang['Group(s) \{%s1\} succesfully merged into "%s2"'] = '已成功將 \{%s1\} 等群組合併至「%s2」。';
$lang['Groups \{%s\} succesfully deleted'] = '已成功刪除 \{%s\} 等群組。';
$lang['It only takes a few clicks.'] = '只需簡單點幾下即可。';
$lang['Keep them'] = '保留';
$lang['Manage album photos'] = '管理相簿中的相片';
$lang['Manage sub-albums'] = '管理子相簿';
$lang['Manage users with user manager'] = '利用使用者管理工具管理使用者';
$lang['Merge'] = '合併';
$lang['Name is already taken'] = '相同的名稱已存在';
$lang['No albums found'] = '找不到符合的相簿';
$lang['No filter on album. Select one or type to search'] = '沒有相簿篩選條件。請先選擇或輸入，再進行搜尋';
$lang['No plugins found'] = '找不到符合的外掛程式';
$lang['No recipient selected'] = '未選擇收件人';
$lang['No tag found'] = '找不到符合的標籤';
$lang['No tags selected, no actions possible.'] = '未選擇任何標籤，無法進行任何動作。';
$lang['No user is permitted to see this private album'] = '沒有使用者可以看到這本私人相簿。';
$lang['No, I have changed my mind'] = '不，還是算了吧';
$lang['Open in gallery'] = '在藝廊中開啟';
$lang['Orphans'] = '不在任何相簿中的照片';
$lang['Other'] = '其他';
$lang['Each email sent will contain its own automatic authentication key on links, valid for %s.'] = '每封發出的 email 中會包含連至自動產生的認證密鑰的連結，有效期限為 %s。';
$lang['Edit user'] = '編輯使用者';
$lang['Edited on %s'] = '上次編輯時間：%s';
$lang['File type: %s'] = '檔案類型：%s';
$lang['For security reason, authentication keys do not work for administrators.'] = '基於安全考量，管理人員無法使用認證密鑰。';
$lang['Formats'] = '格式';
$lang['Group "%s" succesfully deleted'] = '已成功刪除「%s」群組';
$lang['Group added'] = '群組已加入';
$lang['Group renamed'] = '已變更群組名稱';
$lang['%s file type'] = '檔案類型為 %s';
$lang['(determined from photos)'] = '（由內容照片決定）';
$lang['Are you sure you want to lock the gallery?'] = '確定要將此藝廊鎖上嗎？';
$lang['Are you sure you want to update all extensions?'] = '確定要更新所有的延伸功能嗎？';
$lang['Associate User'] = '相關使用者';
$lang['Created on %s'] = '於 %s 建立';
$lang['Display album date period'] = '在每本相簿旁顯示日期區間，例如 « 自 2018 年的 7 月 12 日至 15 日 »';
$lang['Display category date'] = '顯示分類日期';
$lang['Display form'] = '顯示表單';
$lang['Displays a banner to install or open the official Piwigo app'] = '顯示引導安裝與開啟 Piwigo 官方 app 的橫幅廣告';
$lang['Dissociate user from this group'] = '斷開使用者與此群組的關聯';
$lang['You have %s1 orphan : %s2'] = '您有 %s1 個未使用的標籤：%s2';
$lang['and %s others'] = '以及其他 %s 個標籤';
$lang['checksum'] = '檢查碼';
$lang['checksums to add'] = '個待加入的檢查碼';
$lang['delete album and all %d photos, even the %d associated to other albums'] = '刪除相簿以及所有 %d 張照片（其中 %d 與其他相簿有關聯）';
$lang['delete album and the %d orphan photos'] = '刪除相簿以及 %d 張沒有關聯至任何相簿的照片';
$lang['delete only album, not photos'] = '僅刪除相簿，保留照片';
$lang['in administration'] = '在管理介面中';
$lang['in gallery'] = '在畫廊介面中';
$lang['no photo'] = '沒有照片';
$lang['or'] = '或是';
$lang['orphans to delete'] = '要刪除的無所屬照片';
$lang['<b>%d+</b> albums found, try to refine the search'] = '找到 <b>%d+</b> 本相簿，可以試著縮小搜尋條件';
$lang['Add Album'] = '新增相簿';
$lang['Apply an automatic order to root albums'] = '將自動排序規則套用至頂層相簿';
$lang['Apply to direct sub-albums'] = '套用至直屬子相簿';
$lang['Apply to the whole hierarchy'] = '套用至所有子相簿';
$lang['Compact View'] = '精簡檢視';
$lang['Drag and drop to reorder albums'] = '拉動相簿排列順序';
$lang['Hide sub-albums'] = '隱藏子相簿';
$lang['Line View'] = '線性檢視';
$lang['Name field must not be empty'] = '名稱欄位必須要有值';
$lang['Root'] = '頂層';
$lang['Select an album... or type it!'] = '選擇相簿... 或直接輸入！';
$lang['Show sub-albums'] = '顯示子相簿';
$lang['Tile View'] = '塊狀顯示';
$lang['deletion'] = '刪除';
$lang['edit'] = '編輯';
$lang['login'] = '登入';
...
$lang['months ago'] = '個月前';
$lang['move'] = '移動';
$lang['never calculated'] = '從未計算';
$lang['This plugin have been updated recently'] = '這個插件最近有更新';
$lang['This plugin have no update since 3 years ! It may be outdated'] = '這個插件已經 3 年沒有更新了！可能已經過時了';
$lang['This plugin is incompatible with your version'] = '這個插件和你的版本不相容';
$lang['This plugin was updated less than 6 months ago'] = '這個插件在 6 個月內有更新過';
$lang['Try now !'] = '馬上試試！';
$lang['Understood, do not show again'] = '了解，不要再顯示了';
$lang['Update'] = '更新';
$lang['Upload Formats'] = '更新格式';
$lang['User updated'] = '已更新使用者';
$lang['Visited'] = '已造訪';
$lang['While restoring this plugin, it will be reset to its original parameters and associated data is going to be reset'] = '在復原這個插件的同時，所有的參數都會被重置為原本的值，同時相關的資料也會被重置。';
$lang['Your selection'] = '你的選擇';
$lang['Version %s'] = '版本 %s';
$lang['Webmaster status required'] = '需要 Webmaster 狀態';
$lang['Yes, rename'] = '是的，重新命名';
$lang['Memories'] = '紀念品';
$lang['More information'] = '更多資訊';
$lang['New user added'] = '已新增使用者';
$lang['Email'] = '電子郵件';
$lang['Email Adress'] = '電子郵件地址';
$lang['Equivalent to deactivation. The user is still in the list, but can no longer log in.'] = '等同於停用。這名使用者仍會保留在列表中，但無法登入。';
$lang['Error when trying to detect formats'] = '在刪除格式時遇到問題';
$lang['Extensions'] = '擴充套件';
$lang['Filters'] = '篩選條件';
$lang['Generate random password'] = '產生隨機密碼';
$lang['Global Gallery Actions'] = '全域藝廊行為';
$lang['Has access to administration. Can only manage content: photos/albums/users/tags/groups.'] = '有管理權限。只能管理這些內容：照片/相簿/使用者/標籤/群組。';
$lang['Has access to all administration functionnalities. Can manage both configuration and content.'] = '擁有所有管理功能的權限。組態和內容都可以管理。';
$lang['If anything bad happens during the update, you would be able to restore a backup.'] = '如果在升級時發生任何不幸的事情，你都可以利用備份復原。';
$lang['Install Piwigo on mobile'] = '在行動裝置上安裝 Piwigo';
$lang['Installed on %s, %s'] = '已在 %s, %s 安裝';
$lang['Language'] = '語言';
$lang['Last revision date is newer than'] = '最後的版本日期比這個日期還新：';
$lang['Last visit'] = '上次造訪';
$lang['Latest Piwigo news'] = 'Piwigo 的最新消息';
$lang['Locked albums are disabled for maintenance. Only administrators can view them in the gallery. Lock this album will also lock his Sub-albums'] = '被鎖定的相簿因為維護原因而被關閉。只有管理者才能從藝廊中檢視。鎖定此相簿也會一併鎖定其中的子相簿';
$lang['Manage users'] = '管理使用者';
$lang['Cache size'] = '快取大小';
$lang['Can be shared by several individuals without conflict (they cannot change the password).'] = '可以共享給數名使用者而不會互相衝突（這些使用者無法更改密碼）。';
$lang['Change Password'] = '變更密碼';
$lang['Close'] = '關閉';
$lang['Create a new album at root'] = '在最上層建立新的相簿';
$lang['Create a sub-album of "%s"'] = '建立 "%s" 的子相簿';
$lang['Current Version'] = '當前版本';
$lang['Currently running version %s'] = '目前運行中的版本為 %s';
$lang['Deactivated'] = '已停用';
$lang['Delete %s format ?'] = '要刪除格式 %s 嗎？';
$lang['Delete these sizes'] = '刪除這些大小';
$lang['Delete user'] = '刪除使用者';
$lang['Details'] = '詳細資訊';
$lang['Discover'] = '發現';
$lang['Download all activities'] = '下載所有的活動';
$lang['Downloaded'] = '已下載';
$lang['Edit'] = '編輯';
$lang['Edit guest user'] = '編輯訪客使用者';
$lang['Edit photo #%s'] = '編輯照片 #%s';
$lang['Nov'] = '11月';
$lang['Oct'] = '10月';
$lang['Sep'] = '9月';
$lang['Jul'] = '7月';
...
$lang['Aug'] = '8月';
$lang['Dec'] = '12月';
$lang['%s status is required to edit parameters.'] = '想要編輯參數，狀態必須為 %s。';
$lang['%sGB'] = '%s GB';
$lang['%sMB'] = '%s MB';
$lang['Activated'] = '已啟用';
$lang['Activated plugin list'] = '已啟用的插件列表';
$lang['Activity'] = '活動';
$lang['Activity time from'] = '活動時間，從';
$lang['Add New Plugin'] = '新增一個插件';
$lang['Add User'] = '新增使用者';
$lang['Add a new user'] = '新增使用者';
$lang['Add another set of formats'] = '新增另一組格式';
$lang['Add as filter'] = '新增為篩選條件';
$lang['Add formats'] = '新增格式';
$lang['Additional filters'] = '額外的篩選條件';
$lang['Advanced filters'] = '進階篩選條件';
$lang['Always have a backup of your database and files.'] = '總是保存一份資料庫及檔案的備份。';
$lang['Apply to root albums'] = '套用到根相簿';
$lang['Are you sure you want to uninstall the plugin "%s"?'] = '確定要移除 "%s" 這個插件嗎？';
$lang['Are you sure you want to unlock the gallery?'] = '確定要解除這個 gallery 的鎖定狀態嗎？';
$lang['%d user logged out'] = '有 %d 位使用者登出';
$lang['%d users logged in'] = '有 %d 位使用者登入';
$lang['%d users logged out'] = '有 %d 位使用者登出';
$lang['%s MB'] = '%s MB';
$lang['%s line'] = '%s 行';
$lang['%s lines'] = '%s 行';
$lang['%s pixels, %.2f MB'] = '%s 像素，%.2f MB';
$lang['%s plugin found'] = '找到 <b>%s</b> 個插件';
$lang['%s plugins found'] = '找到 <b>%s</b> 個插件';
$lang['%d photo deleted'] = '刪除了 %d 張照片';
$lang['%d photo edited'] = '編輯了 %d 張照片';
$lang['%d photo moved'] = '移動了 %d 張照片';
$lang['%d photos deleted'] = '刪除了 %d 張照片';
$lang['%d photos edited'] = '編輯了 %d 張照片';
$lang['%d photos moved'] = '移動了 %d 張照片';
$lang['%d tag added'] = '新增了 %d 個標籤';
$lang['%d tag deleted'] = '刪除了 %d 個標籤';
$lang['%d tag edited'] = '編輯了 %d 個標籤';
$lang['%d tag moved'] = '移動了 %d 個標籤';
$lang['%d tags added'] = '新增了 %d 個標籤';
$lang['%d tags deleted'] = '刪除了 %d 個標籤';
$lang['%d tags edited'] = '編輯了 %d 個標籤';
$lang['%d tags moved'] = '移動了 %d 個標籤';
$lang['%d user added'] = '新增了 %d 位使用者';
$lang['%d user edited'] = '編輯了 %d 位使用者';
$lang['%d user logged in'] = '有 %d 位使用者登入';
$lang['%d users added'] = '新增了 %d 位使用者';
$lang['%d users edited'] = '編輯了 %d 位使用者';
$lang['%d album added'] = '新增了 %d 本相簿';
$lang['%d album deleted'] = '刪除了 %d 本相簿';
$lang['%d album edited'] = '編輯了 %d 本相簿';
$lang['%d albums added'] = '新增了 %d 本相簿';
$lang['%d albums deleted'] = '刪除了 %d 本相簿';
$lang['%d albums edited'] = '編輯了 %d 本相簿';
$lang['%d formats uploaded for %d photos'] = '更新了 %d 筆格式（來自 %d 張照片）';
$lang['%d group added'] = '新增了 %d 個群組';
$lang['%d group deleted'] = '刪除了 %d 個群組';
$lang['%d group edited'] = '編輯了 %d 個群組';
$lang['%d group moved'] = '移動了 %d 個群組';
$lang['%d groups added'] = '新增了 %d 個群組';
$lang['%d groups deleted'] = '刪除了 %d 個群組';
$lang['%d groups edited'] = '編輯了 %d 個群組';
$lang['%d groups moved'] = '移動了 %d 個群組';
$lang['%d photo added'] = '新增了 %d 張照片';
$lang['%d photos added'] = '新增了 %d 張照片';
$lang['Piwigo core'] = 'Piwigo 核心';
$lang['Piwigo is also on mobile.'] = '在行動裝置上也能使用 Piwigo。';
$lang['Plugin "%s" deleted!'] = '"%s" 插件已刪除！';
$lang['Plugin "%s" has been activated!'] = '"%s" 插件已啟用！';
$lang['Properties of abums'] = '相簿的屬性';
$lang['Purge Actions'] = '清空行動';
$lang['Purge Cache'] = '清空快取';
$lang['Rating greater than'] = '評價大於';
$lang['Registered'] = '已註冊';
$lang['Rename "%s"'] = '重新命名 "%s"';
$lang['Restored'] = '已回復';
$lang['Select groups or type them'] = '選取或輸入群組名稱';
$lang['Selected user'] = '已選定的使用者';
$lang['Show'] = '顯示';
$lang['Show beta test plugins'] = '顯示仍在 BETA 測試中的插件';
$lang['No access to administration, can see private content with appropriate permissions.'] = '無法存取管理者內容，需要適當的權限才能檢視私有內容。';
$lang['No format for this picture'] = '沒有這張照片的格式';
$lang['No picture found with the following name : %s.'] = '找不到符合這個名稱的圖片：%s。';
$lang['No plugin activated'] = '沒有已啟用的插件';
$lang['No research in progress'] = '沒有進行中的研究';
$lang['No search in progress'] = '沒有進行中的搜尋任務';
$lang['Object'] = '物件';
$lang['On %d rating(s)'] = '依照 %d 件評分';
$lang['Photos per page'] = '每頁的照片數量';
$lang['Picture to associate formats with'] = '要與這些格式關連的圖片';
$lang['Users not logged in will have these settings applied, these settings are used by default for new users'] = '未登入的使用者會套用這些設定，而且這些設定會被當成新使用者的預設設定。';
$lang['action successfully performed.'] = '動作成功執行。';
$lang['add'] = '增加';
$lang['and %d more'] = '還有 %d 個';
$lang['between %s and %s'] = '在 %s 和 %s 之間';
$lang['calculated'] = '已計算';
$lang['right now'] = '現在';
$lang['since the beginning'] = '從開始';
$lang['to'] = '到';
$lang['This picture is physically linked to this album, you can\'t dissociate them'] = '這張照片物理上與此相簿連結，你無法取消它們的關聯。';
$lang['This plugin has no recent update'] = '這個外掛套件最近沒有更新';
$lang['Visit history'] = '造訪歷程';
$lang['This photo no longer exists'] = '這張照片已不再存在';
$lang['This photo is an orphan'] = '這張照片未與任何相簿關聯';
$lang['This albums is already in related categories list'] = '這本箱簿已經在相關相簿列表中';
$lang['There is multiple image in the database with the following names : %s.'] = '在資料庫中有多張圖片有下面這個名稱：%s。';
$lang['Theme'] = '主題';
$lang['The best is to have them made automatically on a regular basis.'] = '讓它們定期自動產生為最佳。';
$lang['The original picture will be detected with the filename (without extension).'] = '原始圖片會依檔名（不包含副檔名）偵測';
$lang['Synchronization'] = '同步';
$lang['Tag name'] = '標籤名稱';
$lang['Show plugins compatible with previous version of Piwigo'] = '顯示與上一版 Piwigo 相容的外掛套件';
$lang['Place last'] = '置於最後';
...
$lang['%d in whole branch'] = '整個分枝中有 %d 個項目';
$lang['%d including sub-albums'] = '%d 個項目（包括子相簿）';
$lang['Activate button "%s"'] = '啟用 "%s" 按鈕';
$lang['All admins'] = '所有管理者';
$lang['Allow comments for sub-albums'] = '允許對子相簿發表評論';
$lang['Authorize comments'] = '授權評論';
$lang['Comments allowed for sub-albums'] = '允許對子相簿發表評論';
$lang['Comments disallowed for sub-albums'] = '不允許對子相簿發表評論';
$lang['Created'] = '已建立';
$lang['Detect and avoid duplicates during upload'] = '於上傳時偵測並排除重覆的項目';
$lang['Disallow comments for sub-albums'] = '不允許對子相簿發表評論';
$lang['During upload, if Piwigo detects the photo already exists, associate the existing photo to the destination album, without duplicating file'] = '在上傳的時候，如果 Piwigo 發現照片已經存在，會自動將現存的照片關聯到目標相簿，不會重覆上傳。';
$lang['Locked album'] = '鎖上相簿';
$lang['Modified'] = '已修改';
$lang['Only admins in a specific group'] = '只列出某一群組的管理者';
$lang['Put at the root'] = '放到最底層';
