...
$lang['or'] = 'sau';
$lang['never calculated'] = 'niciodata calculat';
$lang['no photo'] = 'nici o fotografie';
$lang['right now'] = 'in acest moment';
$lang['since the beginning'] = 'de la inceput';
$lang['to'] = 'la';
$lang['deletion'] = 'stergere';
$lang['edit'] = 'editeaza';
$lang['in administration'] = 'in administrare';
$lang['in gallery'] = 'in galerie';
$lang['login'] = 'logare';
$lang['logout'] = 'delogare';
$lang['months ago'] = 'acum cateva luni';
$lang['move'] = 'muta';
$lang['Users not logged in will have these settings applied, these settings are used by default for new users'] = 'Utilizatorii delogati vor avea aceste setari aplicate, aceste setari sunt utilizate implicit pentru utilizatorii noi';
$lang['Version %s'] = 'Versiunea %s';
$lang['Videos'] = 'Videoclipuri';
$lang['Visited'] = 'Vizitat';
$lang['Webmaster status required'] = 'Starea Webmasterului este necesara';
$lang['While restoring this plugin, it will be reset to its original parameters and associated data is going to be reset'] = 'Dupa ce acest modul va fi restaurat va fi resetat la parametrii originali si date asociate lui vor fi resetate.';
$lang['Yes, I am sure'] = 'Da, sunt sigur';
$lang['Yes, delete'] = 'Da, sterge';
$lang['Yes, rename'] = 'Da, redenumeste';
$lang['You don\'t have access to this photo'] = 'Nu ai acces la aceasta fotografie';
$lang['You have %d orphan tags %s'] = 'Ai %d etichete fara parinti %s';
$lang['You have %s inactive plugins'] = 'Ai %s module inactive';
$lang['You have %s1 orphan : %s2'] = 'Ai %s1 fara parinti: %s2';
$lang['Your selection'] = 'Selectia ta';
$lang['action successfully performed.'] = 'actiune realizata cu succes';
$lang['add'] = 'adauga';
$lang['and %d more'] = 'si inca %d ';
$lang['and %s others'] = 'si altele %s ';
$lang['between %s and %s'] = 'intre %s si %s';
$lang['calculated'] = 'calculat';
$lang['There is multiple image in the database with the following names : %s.'] = 'Sunt mai multe imagini in baza de date cu urmatoarele nume: %s.';
$lang['This albums is already in related categories list'] = 'Acest album este deja in lista de albume relevante.';
$lang['This is already the default theme'] = 'Aceasta este deja tema implicita.';
$lang['This photo is an orphan'] = 'Acest album nu are parinti.';
$lang['This photo no longer exists'] = 'Aceasta fotografie nu mai exista.';
$lang['This picture is physically linked to this album, you can\'t dissociate them'] = 'Aceasta imagine este asociata fizic la acest album, nu le poti disocia.';
$lang['This plugin has no recent update'] = 'Acest module nu are o actualizare recenta.';
$lang['This plugin have been updated recently'] = 'Acest modul a fost actualizat recent';
$lang['This plugin have no update since 3 years ! It may be outdated'] = 'Acest modul nu a fost actualizat de 3 ani! S-ar putea sa depasit.';
$lang['This plugin is incompatible with your version'] = 'Acest modul nu este compatibil cu versiunea ta';
$lang['This plugin was updated less than 6 months ago'] = 'Acst modul a fost actualizat in ultimele 6 luni';
$lang['Tile View'] = 'Vizualizare Mozaic';
$lang['Try now !'] = 'Incearca Acum!';
$lang['Understood, do not show again'] = 'Am inteles, nu mai afisa';
$lang['Unset as group for new users'] = 'Nu mai este setat ca grupul pentru utilizatori noi';
$lang['Update'] = 'Actualizeaza';
$lang['Upload Formats'] = 'Incarca Formate';
$lang['User "%s" dissociated from this group'] = 'Utilizaatorul "%s" a fost disociat din acest grup';
$lang['User associated'] = 'Utilizator asociat';
$lang['User updated'] = 'Utilizator actualizat';
$lang['Show'] = 'Afiseaza';
$lang['Show beta test plugins'] = 'Afiseaza modulele aflate in teste beta';
$lang['Show inactive plugins'] = 'Afiseaza modulele inactive';
$lang['Show plugins compatible with previous version of Piwigo'] = 'Afiseaza modulele compatibile cu o versiune anterioara de Piwigo';
$lang['Show sub-albums'] = 'Afiseaza sub-albumele';
$lang['Showing %s users out of %s'] = 'Se afiseaza %s utilizator din %s';
$lang['Storage'] = 'Stocare';
$lang['Synchronization'] = 'Sincronizare ';
$lang['Tag "%s" created'] = 'Eticheta "%s" a fost creata.';
$lang['Tag "%s" succesfully deleted'] = 'Eticheta \"%s\" a fost stearsa cu succes.';
$lang['Tag "%s1" renamed in "%s2"'] = 'Eticheta \"%s1\" a fost redenumita in \"%s2\"';
$lang['Tag Manager'] = 'Manager de etichete';
$lang['Tag name'] = 'Numele etichetei';
$lang['Tag(s) \{%s1\} succesfully merged into "%s2"'] = 'Eticheta(ele) \{%s1\} au fost fuzionate cu succes in "%s2"';
$lang['Tags \{%s\} succesfully deleted'] = 'Eticheta \{%s\} a fost stearsa cu success';
$lang['The %d tags on this page are selected'] = '%d etichete din aceasta pagina sunt selectate';
$lang['The best is to have them made automatically on a regular basis.'] = 'Cel mai bine este sa fie generate automat la un interval regulat.';
$lang['The original picture will be detected with the filename (without extension).'] = 'Imaginea originala va fi detectata cu denumirea fisierului(fara extensie).';
$lang['The other tags will be removed'] = 'Celelalte etichete vor fi sterse';
$lang['Theme'] = 'Tema';
$lang['Purge Cache'] = 'Stergere cache';
$lang['Rating greater than'] = 'Ratinguri mai mari decat';
$lang['Refresh thumbnail'] = 'Reimprospateaza imaginea miniatura';
$lang['Registered'] = 'Inregistrat';
$lang['Rename "%s"'] = 'Redenumeste "%s"';
$lang['Requires PHP %s'] = 'Necesita PHP %s';
$lang['Restored'] = 'Restaurat';
$lang['Review'] = 'Recenzie';
$lang['Root'] = 'Baza';
$lang['Search albums'] = 'Cautare albume';
$lang['Search tips'] = 'Cautare sfaturi';
$lang['Select'] = 'Selecteaza';
$lang['Select all %d tags'] = 'Selecteaza toate cele %d etichetele ';
$lang['Select an album... or type it!'] = 'Selecteaza un album... sau introduce-l';
$lang['Select groups or type them'] = 'Selecteaza grupuri sau introducele';
$lang['Selected user'] = 'Utilizatorul selectat';
$lang['Selection mode'] = 'Module de selectie';
$lang['Sep'] = 'Sep';
$lang['Set as default'] = 'Seteaza ca implicit';
$lang['Set as group for new users'] = 'Seteaza ca grup pentru utilzatori noi';
$lang['Oct'] = 'Oct';
$lang['On %d rating(s)'] = 'Din %d rating(uri)';
$lang['Open in gallery'] = 'Deschide in galerie';
$lang['Other'] = 'Altele';
$lang['Page Visited'] = 'Pagina vizitata';
$lang['Page Visited in %s'] = 'Pagina vizitata pe  %s';
$lang['Photos per page'] = 'Fotografii pe pagina';
$lang['Picture to associate formats with'] = 'Imagine cu care sa asociezi formatele';
$lang['Piwigo core'] = 'Nucleul Piwigo';
$lang['Piwigo is also on mobile.'] = 'Piwigo este si pe telefon.';
$lang['Place first'] = 'Plaseaza primul';
$lang['Place last'] = 'Plaseaza ultimul';
$lang['Please upgrade your PHP version before any update.'] = 'Va rugam sa actualizati versiunea de PHP inainte de actualizare';
$lang['Plugin "%s" deleted!'] = 'Modulul "%s" sters!';
$lang['Plugin "%s" has been activated!'] = 'Modulul "%s" a fost activat!';
$lang['Portraits'] = 'Portrete';
$lang['Posted %s'] = 'Postat %s';
$lang['Promote mobile app on mobile devices'] = 'Promoveaza aplicatia mobila pe dispozitivele mobile';
$lang['Properties of abums'] = 'Proprietatile albumului';
$lang['Purge Actions'] = 'Stergere actiuni.';
$lang['Mar'] = 'Mar';
$lang['May'] = 'Mai';
$lang['Memories'] = 'Suveniruri';
$lang['Merge'] = 'Fuzioneaza';
$lang['More information'] = 'Mai multa informatie';
$lang['Name field must not be empty'] = 'Numele campului nu trebuie sa fie gol';
$lang['Name is already taken'] = 'Numele este deja utilizat';
$lang['New user added'] = 'Utilizator nou adaugat';
$lang['No access to administration, can see private content with appropriate permissions.'] = 'Fara acces la administrare, poate vedea continutul priviat cu permisiile corespunzatoare.';
$lang['No albums found'] = 'Nu au fost gasite albume';
$lang['No format for this picture'] = 'Nici un format pentru aceasta fotografie';
$lang['No picture found with the following name : %s.'] = 'Nu au fost gasite fotografii cu urmatorul nume: %s.';
$lang['No plugin activated'] = 'Nici un modul activat';
$lang['No plugins found'] = 'Nici un modul gasit';
$lang['No research in progress'] = 'Nici o re-cautare in derulare';
$lang['No search in progress'] = 'Nici o cautare in derulare';
$lang['No tag found'] = 'Nici o eticheta gasita';
$lang['No, I have changed my mind'] = 'Nu, m-am razgandit';
$lang['Nov'] = 'Noi';
$lang['Object'] = 'Obiect';
$lang['Has access to administration. Can only manage content: photos/albums/users/tags/groups.'] = 'Are acces la administrare. Poate gestiona continutul: fotografii/albume/utilizatori/etichete/grupuri.';
$lang['Has access to all administration functionnalities. Can manage both configuration and content.'] = 'Are access la toate functiile de administrare. Poate gestiona si configuratia si continutul.';
$lang['Hide sub-albums'] = 'Ascunde sub-albume';
$lang['If anything bad happens during the update, you would be able to restore a backup.'] = 'Daca ceva se va intampla in timpul actualizarii vei putea restaura un backup.';
$lang['Install Piwigo on mobile'] = 'Instaleaza Piwigo pe telefon';
$lang['Installed on %s, %s'] = 'Instalat pe %s, %s';
$lang['Jan'] = 'Ian';
$lang['Jul'] = 'Iul';
$lang['Jun'] = 'Iun';
$lang['Keep them'] = 'Pastreaza-le';
$lang['Language'] = 'Limba';
$lang['Last revision date is newer than'] = 'Data ultimei revizuiri este mai noua decat';
$lang['Last visit'] = 'Ultima vizita';
$lang['Latest Piwigo news'] = 'Cele mai recente stiri Piwigo';
$lang['Line View'] = 'Vedere in linie';
$lang['Locked albums are disabled for maintenance. Only administrators can view them in the gallery. Lock this album will also lock his Sub-albums'] = 'Albumele blocate sunt dezactivate pentru mentenanta. Doar administratorii le pot vedea in galerie. Blocarea acestui album va bloca si sub-albumele lui.';
$lang['Manage album photos'] = 'Gestioneaza fotografiile albumului';
$lang['Manage sub-albums'] = 'Gestioneaza sub-album';
$lang['Manage users'] = 'Gestioneaza utilizator';
$lang['Manage users with user manager'] = 'Gestioneaza utilizator cu gestiunea de utilizatori';
$lang['Edit'] = 'Editeaza';
$lang['Edit guest user'] = 'Editeaza utilizatorul oaspete';
$lang['Edit photo #%s'] = 'Editeaza fotografia #%s';
$lang['Edited on %s'] = 'Editat pe %s';
$lang['Email'] = 'Email';
$lang['Email Adress'] = 'Adresa Email';
$lang['Equivalent to deactivation. The user is still in the list, but can no longer log in.'] = 'Echivalent cu deactivarea. Utilizatorul inca este pe lista dar nu se mai poate loga.';
$lang['Error when trying to detect formats'] = 'Eroare la detectarea formatelor.';
$lang['Extensions'] = 'Extensii';
$lang['Feb'] = 'Feb';
$lang['File type: %s'] = 'Tipul fisierului: %s';
$lang['Filters'] = 'Filtre';
$lang['Formats'] = 'Formate';
$lang['Generate random password'] = 'Generaza parola aleatoriu';
$lang['Global Gallery Actions'] = 'Actiunile Galeriei Globale';
$lang['Group "%s" succesfully deleted'] = 'Grupul "%s" sters cu succes';
$lang['Group added'] = 'Grup adaugat';
$lang['Group renamed'] = 'Grup redenumit';
$lang['Group(s) \{%s1\} succesfully merged into "%s2"'] = 'Grup(urile) \{%s1\} fuzionate cu success in "%s2"';
$lang['Groups \{%s\} succesfully deleted'] = 'Groups \{%s\} sterse cu success';
$lang['Current Version'] = 'Versiunea Curenta';
$lang['Currently running version %s'] = 'Versiunea curenta care ruleaza este %s';
$lang['Deactivated'] = 'Deactivat';
$lang['Dec'] = 'Dec';
$lang['Delete %s format ?'] = 'Sterge  %s formatul?';
$lang['Delete album'] = 'Sterge album';
$lang['Delete orphan tags ?'] = 'Sterge etichetele fara parinti ?';
$lang['Delete tag "%s"?'] = 'Sterge eticheta %s?';
$lang['Delete tags \{%s\}?'] = 'Sterge etichetele \{%s\}?';
$lang['Delete them'] = 'Sterge-le';
$lang['Delete these sizes'] = 'Sterge aceste dimensiuni';
$lang['Delete user'] = 'Sterge utilizator';
$lang['Details'] = 'Detalii';
$lang['Discover'] = 'Descopera';
$lang['Display'] = 'Afiseaza';
$lang['Displays a banner to install or open the official Piwigo app'] = 'Afiseaza un baner  pentru a instala aplicatia oficiala Piwigo';
$lang['Dissociate user from this group'] = 'Disociaza utilizatorul din acest grup';
$lang['Download all activities'] = 'Descarca toate activitatile';
$lang['Downloaded'] = 'Descarca';
$lang['Drag and drop to reorder albums'] = 'Trage si plaseaza pentru a reordona albumele';
$lang['Are you sure you want to uninstall the plugin "%s"?'] = 'Esti sigur ca vrei sa dezinstalezi modulul "%s"?';
$lang['Are you sure you want to unlock the gallery?'] = 'Esti sigur ca vrei sa deblochezi galeria?';
$lang['Are you sure you want to update all extensions?'] = 'Esti sigur ca vrei sa actualizezi toate extensiile?';
$lang['Associate User'] = 'Asociaza Utilizator';
$lang['At least 2 selected tags are needed to merge'] = 'Cel putine 2 etichete selectate sunt necesare pentru a fuziona';
$lang['Aug'] = 'Aug';
$lang['Average last 12 months'] = 'Media ultimelor 12 luni';
$lang['Cache'] = 'Cache';
$lang['Cache size'] = 'Dimensiunea cache-ului';
$lang['Can be shared by several individuals without conflict (they cannot change the password).'] = 'Poate fi partajata de mai multe persoane fara conflict(nu pot schimba parola)';
$lang['Certification higher or equal to'] = 'Certificare mai mare sau egala cu';
$lang['Change Password'] = 'Schimba Parola';
$lang['Choose which tag to merge these tags into'] = 'Alege in ce eticheta sa fie fuzionate aceste etichete';
$lang['Clear Selection'] = 'Golire Selectie';
$lang['Close'] = 'Inchide';
$lang['Compact View'] = 'Vedere Compacta';
$lang['Compare mode'] = 'Modul comparare';
$lang['Create a new album at root'] = 'Creaza un album nou la baza';
$lang['Create a sub-album of "%s"'] = 'Create un sub-album al lui"%s"';
$lang['Created on %s'] = 'Create pe "%s"';
$lang['Apply an automatic order to root albums'] = 'Aplica o ordine automata albumelor de baza';
$lang['Apply to direct sub-albums'] = 'Aplica sub-albumelor directe';
$lang['Apply to root albums'] = 'Aplica albumelor de baza';
$lang['Apply to the whole hierarchy'] = 'Aplica pe toata ierarhia';
$lang['Apr'] = 'Apr';
$lang['Are you sure you want to delete all sizes?'] = 'Esti sigur ca vrei sa stergi toate dimensiunile?';
$lang['Are you sure you want to delete group "%s"?'] = 'Esti sigur ca vrei sa stergi grupul "%s"?';
$lang['Are you sure you want to delete the language "%s"?'] = 'Esti sigur ca vrei sa stergi limba "%s"?';
$lang['Are you sure you want to delete the plugin "%s"?'] = 'Esti sigur ca vrei sa stergi modulul "%s"?';
$lang['Are you sure you want to delete the ratings of the user "%s"?'] = 'Esti sigur ca vrei sa ratingurile utilizatorului "%s"?';
$lang['Are you sure you want to delete the theme "%s"?'] = 'Esti sigur ca vrei sa stergi tema "%s"?';
$lang['Are you sure you want to delete the user "%s"?'] = 'Esti sigur ca vrei sa stergi utilizatorul "%s"?';
$lang['Are you sure you want to delete this site?'] = 'Esti sigur ca vrei sa stergi acest site?';
$lang['Are you sure you want to delete this theme?'] = 'Esti sigur ca vrei sa stergi aceasta tema?';
$lang['Are you sure you want to delete this?'] = 'Esti sigur ca vrei sa stergi asta?';
$lang['Are you sure you want to install the plugin "%s"?'] = 'Esti sigur ca vrei sa instalezi modulul "%s"?';
$lang['Are you sure you want to lock the gallery?'] = 'Esti sigur ca vrei sa blochezi galeria?';
$lang['Are you sure you want to restore the plugin "%s"?'] = 'Esti sigur ca vrei sa restaurezi modulul "%s"?';
$lang['Are you sure you want to restore this plugin?'] = 'Esti sigur ca vrei sa restaurezi acest modulul?';
$lang['Are you sure you want to restore to default settings?'] = 'Esti sigur ca vrei sa restaurezi setarile implicite?';
$lang['<b>%d</b> tag found'] = '<b>%d</b> eticheta gasita';
$lang['<b>%d</b> tag selected'] = '<b>%d</b> eticheta selectata';
$lang['<b>%d</b> tags found'] = '<b>%d</b> etichete gasite';
$lang['<b>1</b> album found'] = '<b>1</b> album gasit';
$lang['Activated'] = 'Activat';
$lang['Activated plugin list'] = 'Lista module activata';
$lang['Activity'] = 'Activitate';
$lang['Activity peak in the last weeks'] = 'Activitatea maxima in ultimele saptamani';
$lang['Activity time from'] = 'Timpul activitatii de la';
$lang['Add Album'] = 'Adaugare album';
$lang['Add New Plugin'] = 'Adaugare modul nou';
$lang['Add User'] = 'Adauga utilizator';
$lang['Add a new user'] = 'Adauga un utilizator nou';
$lang['Add another set of formats'] = 'Adauga un alt set de formate';
$lang['Add as filter'] = 'Adauga ca filtru';
$lang['Add formats'] = 'Adauga formate';
$lang['Additional filters'] = 'Filtre aditionale';
$lang['Advanced filters'] = 'Filtre avansate';
$lang['Album search tool'] = 'Unealta cautare album';
$lang['Always have a backup of your database and files.'] = 'Intodeauna sa ai un back-up al bazei tale de date si a fisierelor.';
$lang['%d user logged out'] = '%d user delogat';
$lang['%d users added'] = '%d useri adaugati';
$lang['%d users edited'] = '%d useri editati';
$lang['%d users logged in'] = '%d useri logati';
$lang['%d users logged out'] = '%d useri delogati';
$lang['%s GB used'] = '%s GB utilizati';
$lang['%s MB'] = '%s MB';
$lang['%s MB used'] = '%s MB utilizati';
$lang['%s file type'] = '%s tipul fisierului';
$lang['%s line'] = '%s linie';
$lang['%s lines'] = '%s linii';
$lang['%s other tags available..'] = '%s alte etichete disponibile...';
$lang['%s pixels, %.2f MB'] = '%s pixeli, %.2f MB';
$lang['%s plugin found'] = '<b>%s</b> modul gasit';
$lang['%s plugins found'] = '<b>%s</b> module gasite';
$lang['%s status is required to edit parameters.'] = '%s starea este necesara pentru editarea parametrilor.';
$lang['%sGB'] = '%s GB';
$lang['%sMB'] = '%s MB';
$lang['<b>%d+</b> albums found, try to refine the search'] = '<b>%d+</b> albume gasite, incearca sa imbunatatesti cautarea';
$lang['<b>%d</b> albums found'] = '<b>%d</b> albume gasite';
$lang['%d photo deleted'] = '%d fotografie stearsa';
$lang['%d photo edited'] = '%d fotografie editata';
$lang['%d photo moved'] = '%d fotografie mutata';
$lang['%d photos'] = '%d fotografii';
$lang['%d photos added'] = '%d fotografii adaugate';
$lang['%d photos deleted'] = '%d fotografii sterse';
$lang['%d photos edited'] = '%d fotografii editate';
$lang['%d photos moved'] = '%d fotografii mutate';
$lang['%d sub-albums'] = '%d sub-albume';
$lang['%d tag added'] = '%d eticheta adaugata';
$lang['%d tag deleted'] = '%d eticheta stearsa';
$lang['%d tag edited'] = '%d eticheta editata';
$lang['%d tag moved'] = '%d eticheta mutata';
$lang['%d tags added'] = '%d etichete adaugate';
$lang['%d tags deleted'] = '%d etichete sterse';
$lang['%d tags edited'] = '%d etichete editate';
$lang['%d tags moved'] = '%d etichete mutate';
$lang['%d user added'] = '%d user adaugat';
$lang['%d user edited'] = '%d user editat';
$lang['%d user logged in'] = '%d user logat';
$lang[' (copy %s)'] = '(copiaza %s)';
$lang[' (copy)'] = '(copiaza)';
$lang['%d Activities'] = '%d Activitati';
$lang['%d Activity'] = '%d Activitate';
$lang['%d album added'] = '%d album adaugat';
$lang['%d album deleted'] = '%d album sters';
$lang['%d album edited'] = '%d album editat';
$lang['%d albums added'] = '%d albume adaugate';
$lang['%d albums deleted'] = '%d albume sterse';
$lang['%d albums edited'] = '%d albume editate';
$lang['%d formats uploaded for %d photos'] = '%d  formate incarcate pentru %d fotografii';
$lang['%d group added'] = '%d grup adaugat';
$lang['%d group deleted'] = '%d grup sters';
$lang['%d group edited'] = '%d grup editat';
$lang['%d group moved'] = '%d grup mutat';
$lang['%d groups added'] = '%d grupuri adaugate';
$lang['%d groups deleted'] = '%d grupuri sterse';
$lang['%d groups edited'] = '%d grupuri editate';
$lang['%d groups moved'] = '%d grupuri mutate';
$lang['%d photo added'] = '%d fotografie adaugata';
$lang['%d pictures in sub-albums'] = '%d fotografii in sub-albume';
$lang['<b>%d</b> filtered user'] = '<b>%d</b> utilizator selectat';
$lang['<b>%d</b> filtered users'] = '<b>%d</b> utilizatori selectati';
$lang['Album name must not be empty'] = 'Numele albumului nu poate fi gol.';
$lang['Some photos are missing from your file system. Details provided by plugin Check Uploads'] = 'Unele fotografii lipsesc din sistemul dumneavoastra de fisiere.';
$lang['Visit history'] = 'Vezi istoric';
