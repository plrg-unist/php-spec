...
$lang['You can update to Piwigo %s directly, without upgrading to Piwigo %s (recommended).'] = 'Je kunt direct naar Piwigo %s updaten, zonder eerst te up-daten naar Piwigo %s (aanbevolen)';
...
$lang['since the beginning'] = 'sinds het begin';
