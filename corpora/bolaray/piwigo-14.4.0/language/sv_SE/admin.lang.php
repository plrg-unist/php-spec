...
$lang['The original image quality must be a number between %d and %d'] = 'Originalets bildkvalitet måste vara ett nummer mellan %d och %d';
...
$lang['Created on %s'] = 'Skapad den %s';
...
$lang['%d in whole branch'] = '%d i hela grenen';
$lang['%d including sub-albums'] = '%d inklusive underalbum';
$lang['Activate button "%s"'] = 'Aktivera knapp "%s"';
$lang['All admins'] = 'Alla admins';
$lang['Allow comments for sub-albums'] = 'Tillåt kommentarer för underalbum';
$lang['Authorize comments'] = 'Auktorisera kommentarer';
$lang['Comments allowed for sub-albums'] = 'Kommentarer tillåtna för underalbum';
$lang['Comments disallowed for sub-albums'] = 'Kommentarer icke tillåtna för underalbum';
$lang['Created'] = 'Skapad';
$lang['Detect and avoid duplicates during upload'] = 'Upptäck och undvik dubletter vid uppladdning';
$lang['Disallow comments for sub-albums'] = 'Tillåt inte kommentarer för underalbum';
$lang['During upload, if Piwigo detects the photo already exists, associate the existing photo to the destination album, without duplicating file'] = 'Under uppladdning, om Piwigo upptäcker att fotot redan finns, associera det befintliga fotot till målalbumet, utan att duplicera filen';
$lang['Locked album'] = 'Låst album';
$lang['Modified'] = 'Ändrad';
$lang['Only admins in a specific group'] = 'Endast admins i en specifik grupp';
$lang['Put at the root'] = 'Sätt vid roten';
$lang['Remove thumbnail'] = 'Ta bort miniatyrbild';
