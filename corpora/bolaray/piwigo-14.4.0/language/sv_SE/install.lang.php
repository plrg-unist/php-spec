...
$lang['also given by your host provider'] = 'också tilldelad av ditt webbhotell';
...
$lang['PHP 5 is required'] = 'PHP 5.3 krävs';
$lang['It appears your webhost is currently running PHP %s.'] = 'Ditt webbhotell använder just nu PHP %s.';
$lang['Piwigo may try to switch your configuration to PHP 5 by creating or modifying a .htaccess file.'] = 'Piwigo kan kanske komma att ändra dina inställningar i PHP 5.3 genom att skapa eller ändra en .htaccess fil.';
...
$lang['Try to configure PHP 5'] = 'Försök att konfigurera PHP 5.3';
$lang['Sorry!'] = 'Ursäkta!';
$lang['Piwigo was not able to configure PHP 5.'] = 'Piwigo kunde inte konfigurera PHP 5.3';
$lang['You may referer to your hosting provider\'s support and see how you could switch to PHP 5 by yourself.'] = 'Vi rekomenderar att du kontaktar leverantören för ditt webbhotell för att se hur du kan ändra till PHP 5.3';
...
$lang['You can download the config file and upload it to local/config directory of your installation.'] = 'Du kan ladda ner konfigurationsfilen och sedan ladda upp den till local/config-katalogen i din installation .';
...
$lang['PHP version %s required (you are running on PHP %s)'] = 'PHP version %s krävs (du kör nu PHP version %s)';
