...
$lang['%d in whole branch'] = 'Tüm dalda %d';
$lang['Activate button "%s"'] = '"%s" düğmesini etkinleştir';
$lang['Detect and avoid duplicates during upload'] = 'Yükleme sırasında kopyaları tespit edin ve önleyin';
$lang['Disallow comments for sub-albums'] = 'Alt albümler için yorumlara izin verme';
$lang['During upload, if Piwigo detects the photo already exists, associate the existing photo to the destination album, without duplicating file'] = 'Yükleme sırasında Piwigo fotoğrafın zaten mevcut olduğunu tespit ederse, dosyayı kopyalamadan mevcut fotoğrafı hedef albümle ilişkilendirir';
$lang['Only admins in a specific group'] = 'Yalnızca belirli bir gruptaki yöneticiler';
$lang['Put at the root'] = 'Kök dizine yerleştir';
$lang['Remove thumbnail'] = 'Küçük resmi kaldır';
$lang['This album is currently locked, visible only to administrators.'] = 'Bu albüm şu anda kilitli ve yalnızca yöneticiler tarafından görülebilir.';
$lang['Unlocked album'] = 'Kilidi açılmış albüm';
$lang['Locked album'] = 'Kilitli albüm';
$lang['Unlock it'] = 'Kilidi aç';
$lang['Modified'] = 'Değiştirildi';
$lang['Created'] = 'Oluşturuldu';
$lang['Comments disallowed for sub-albums'] = 'Alt albümler için yorumları yasakla';
$lang['Comments allowed for sub-albums'] = 'Alt albümler için yorumlara izin ver';
$lang['Authorize comments'] = 'Yorumları yetkilendir';
