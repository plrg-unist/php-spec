...
$lang['Use the default photo sort order'] = 'Χρησιμοποιήστε τηn προεπιλεγμένη σειρά ταξινόμησης φωτογραφιών';
...
$lang['Y Repeat'] = 'Y Επανάληψη';
$lang['Recipients'] = 'Παραλήπτες';
$lang['Orphans'] = 'Ορφανά';
$lang['No user is permitted to see this private album'] = 'Κανένας χρήστης δεν επιτρέπεται να δεί αυτό το ιδιωτικό λεύκωμα';
$lang['No recipient selected'] = 'Δεν έχει επιλεγεί παραλήπτης';
...
$lang['Jul'] = 'Ιούλ';
$lang['Jun'] = 'Ιούν';
$lang['%d group edited'] = '%d ομάδα επεξεργάστικε  ';
$lang['%d groups edited'] = '%d ομάδες  επεξεργάστικαν ';
$lang['%d groups deleted'] = '%d ομάδες αφαιρέθηκαν';
$lang['%d groups added'] = '%d ομάδες  προστέθηκε';
$lang['%d group moved'] = '%d ομάδα μετακινήθηκε ';
$lang['%d group deleted'] = '%d ομάδα  αφαιρέθηκε';
$lang['%d albums edited'] = '%d λεύκωμα επεξεργάστικε';
$lang['%d group added'] = '%d ομάδα  προστέθηκε';
$lang['%d albums deleted'] = '%d albums αφαιρέθηκε';
$lang['%d album edited'] = '%d λεύκωμα επεξεργάστικε';
$lang['%d albums added'] = '%d λεύκωμα προστέθηκε';
$lang['%d album deleted'] = '%d λεύκωμα αφαιρέθηκε';
$lang['%d album added'] = '%d λεύκωμα προστέθηκε';
$lang['<b>%d+</b> albums found, try to refine the search'] = 'Βρέθηκαν <b>%d+</b> λεύκωμα, προσπαθήστε να κάνετε πιο συγκεκριμένη την αναζήτηση';
$lang['%s status is required to edit parameters.'] = 'Κατάσταση %s απαιτείται για την επεξεργασία των παραμέτρων.';
$lang['to'] = 'προς το';
$lang['right now'] = 'τώρα αμέσως';
$lang['no photo'] = 'δεν υπάρχει φωτογραφία';
$lang['never calculated'] = 'ποτέ δεν υπολογίζεται';
$lang['move'] = 'μετακίνηση';
$lang['months ago'] = 'μήνες πριν';
$lang['%s plugins found'] = 'Βρέθηκαν <b>%s</b> πρόσθετα';
$lang['%s plugin found'] = 'Βρέθηκε <b>%s</b> πρόσθετο ';
$lang['%s line'] = '%s γραμμή';
$lang['%s lines'] = '%s γραμμές';
$lang['%s MB'] = '%s MB';
$lang['%d users logged out'] = '%d χρήστες αποσυνδέθηκαν';
$lang['%d users logged in'] = '%d χρήστες έχουν συνδεθεί';
$lang['%d users edited'] = '%d χρήστες επεξεργάστηκαν';
$lang['%d users added'] = 'Προστέθηκαν %d χρήστες';
$lang['%d user logged out'] = '%d χρήστης αποσυνδέθηκε';
$lang['%d user logged in'] = '%d χρήστης έχει συνδεθεί';
$lang['%d user edited'] = '%d χρήστης επεξεργάστηκε';
$lang['%d user added'] = 'Προστέθηκε %d χρήστης';
$lang['%d tags moved'] = 'Μετακινήθηκαν %d ετικέτες';
$lang['%d tags deleted'] = '%d ετικέτες διαγράφηκαν';
$lang['%d tags edited'] = '%d ετικέτες επεξεργάστηκαν';
$lang['%d tags added'] = 'Προστέθηκαν %d ετικέτες';
$lang['%d tag moved'] = 'Μετακινήθηκε %d ετικέτα';
$lang['%d tag edited'] = '%d ετικέτα επεξεργάστηκε';
$lang['%d tag deleted'] = '%d ετικέτα διαγράφηκε';
$lang['%d tag added'] = 'Προστέθηκε %d ετικέτα';
$lang['%d photos moved'] = 'Μετακινήθηκαν %d φωτογραφίες';
$lang['%d photos edited'] = '%d φωτογραφίες επεξεργάστηκαν';
$lang['%d photos deleted'] = '%d φωτογραφίες διαγράφηκαν';
$lang['%d photos added'] = 'Προστέθηκαν %d φωτογραφίες';
$lang['%d photo moved'] = '%d φωτογραφία μετακινήθηκε';
$lang['%d photo edited'] = '%d φωτογραφία επεξεργάστηκε';
$lang['%d photo added'] = 'Προστέθηκε %d φωτογραφία';
$lang['%d photo deleted'] = '%d φωτογραφία διαγράφηκε';
$lang['%d groups moved'] = '%d ομάδες μετακινήθηκαν';
$lang['Apply to root albums'] = 'Εφαρμογή σε root λευκώματα';
$lang['Apply to direct sub-albums'] = 'Εφαρμογή σε απευθείας υπο-λευκώματα';
$lang['Apply an automatic order to root albums'] = 'Εφαρμόστε μια αυτόματη ταξινόμηση στα root λευκώματα';
$lang['Always have a backup of your database and files.'] = 'Έχετε πάντα αντίγραφο ασφαλείας της βάσης δεδομένων και των αρχείων σας.';
$lang['All admins'] = 'Όλοι οι διαχειριστές';
$lang['Allow comments for sub-albums'] = 'Να επιτρέπονται σχόλια για υπο-λευκώματα';
$lang['Add as filter'] = 'Προσθήκη ως φίλτρο';
$lang['Add formats'] = 'Προσθήκη φορματ';
$lang['Additional filters'] = 'Πρόσθετα φίλτρα';
$lang['Advanced filters'] = 'Προηγμένα φίλτρα';
$lang['Album name must not be empty'] = 'Το όνομα του λευκώματος δεν πρέπει να είναι κενό';
$lang['Add another set of formats'] = 'Προσθέστε ένα άλλο σετ φορματ';
$lang['Add a new user'] = 'Προσθήκη νέου χρήστη';
$lang['Add User'] = 'Πρόσθεσε χρήστη';
$lang['Add New Plugin'] = 'Προσθέστε ένα νέο πρόσθετο';
$lang['Add Album'] = 'Προσθήκη λευκώματος';
$lang['Activity time from'] = 'Χρόνος δραστηριότητας από';
$lang['Activity'] = 'Δραστηριότητα';
$lang['Activated plugin list'] = 'Ενεργοποιημένη λίστα πρόσθετων';
$lang['Activated'] = 'Ενεργοποιημένος';
$lang['Activate button "%s"'] = 'Ενεργοποίηση κουμπιού "%s"';
$lang['<b>%d</b> filtered users'] = '<b>%d</b> φιλτραρισμένοι χρήστες';
$lang['<b>%d</b> filtered user'] = 'Φιλτραρισμένος χρήστης <b>%d</b>';
$lang['%sMB'] = '%s MB';
$lang['%d in whole branch'] = '%d σε ολόκληρο τον κλάδο';
$lang['%sGB'] = '%s GB';
$lang['%s pixels, %.2f MB'] = '%s pixel, %.2f MB';
$lang['%d pictures in sub-albums'] = '%d εικόνες σε υπο-λευκώματα';
$lang['%d including sub-albums'] = '%d συμπεριλαμβανομένων των υπο-λευκωμάτων';
$lang['%d formats uploaded for %d photos'] = '%d μορφές μεταφορτώθηκαν για %d φωτογραφίες';
$lang['Mar'] = 'Μαρ';
$lang['Merge'] = 'Συγχώνευση';
$lang['Memories'] = 'Αναμνηστικά';
$lang['May'] = 'Μαη';
$lang['Manage users with user manager'] = 'Διαχειριστείτε τους χρήστες με τον διαχειριστή χρηστών';
$lang['Manage users'] = 'Διαχείριση χρηστών';
$lang['Manage sub-albums'] = 'Διαχείριση υπο-λευκώματος';
$lang['Manage album photos'] = 'Διαχείριση φωτογραφιών λευκώματος ';
$lang['Locked albums are disabled for maintenance. Only administrators can view them in the gallery. Lock this album will also lock his Sub-albums'] = 'Τα κλειδωμένα λευκώματα είναι απενεργοποιημένα για συντήρηση. Μόνο οι διαχειριστές μπορούν να τα δουν στη συλλογή. Το κλείδωμα αυτού του λευκώματος θα κλειδώσει και τα δευτερεύοντα άλμπουμ του.';
$lang['Locked album'] = 'Κλειδωμένο λεύκωμα';
$lang['Line View'] = 'Προβολή γραμμική';
$lang['Latest Piwigo news'] = 'Τα τελευταία νέα του Piwigo';
$lang['Last visit'] = 'Τελευταία επίσκεψη';
$lang['Last revision date is newer than'] = 'Η ημερομηνία τελευταίας αναθεώρησης είναι νεότερη από';
$lang['Language'] = 'Γλώσσα';
$lang['Keep them'] = 'Κρατα τους';
$lang['Jan'] = 'Ιαν';
$lang['Installed on %s, %s'] = 'Εγκατεστημένο σε %s, %s';
$lang['Install Piwigo on mobile'] = 'Εγκαταστήστε το Piwigo σε κινητό';
$lang['If anything bad happens during the update, you would be able to restore a backup.'] = 'Εάν συμβεί κάτι κακό κατά την ενημέρωση, θα μπορείτε να επαναφέρετε ένα αντίγραφο ασφαλείας.';
$lang['Hide sub-albums'] = 'Απόκρυψη υπο-άλμπουμ';
$lang['Has access to all administration functionnalities. Can manage both configuration and content.'] = 'Έχει πρόσβαση σε όλες τις λειτουργίες διαχείρισης. Μπορεί να διαχειριστεί τόσο τη διαμόρφωση όσο και το περιεχόμενο.';
$lang['Has access to administration. Can only manage content: photos/albums/users/tags/groups.'] = 'Έχει πρόσβαση στη διοίκηση. Μπορεί να διαχειριστεί μόνο περιεχόμενο: φωτογραφίες/λευκώματα/χρήστες/ετικέτες/ομάδες.';
$lang['Groups \{%s\} succesfully deleted'] = 'Οι ομάδες \{%s\} διαγράφηκαν επιτυχώς';
$lang['Group(s) \{%s1\} succesfully merged into "%s2"'] = 'Οι ομάδες \{%s1\} συγχωνεύτηκαν επιτυχώς στο "%s2"';
$lang['Group renamed'] = 'Η ομάδα μετονομάστηκε';
$lang['Group added'] = 'Η ομάδα προστέθηκε';
$lang['Group "%s" succesfully deleted'] = 'Η ομάδα "%s" διαγράφηκε επιτυχώς';
$lang['Global Gallery Actions'] = 'Global Gallery Actions';
$lang['File type: %s'] = 'Τύποι αρχείων %s';
$lang['Formats'] = 'Μορφές';
$lang['Generate random password'] = 'Δημιουργήστε τυχαίο κωδικό πρόσβασης';
$lang['Filters'] = 'Φίλτρα';
$lang['Feb'] = 'Φεβ';
$lang['Extensions'] = 'Επεκτάσεις';
$lang['Error when trying to detect formats'] = 'Σφάλμα κατά την προσπάθεια ανίχνευσης φορματ';
$lang['Equivalent to deactivation. The user is still in the list, but can no longer log in.'] = 'Ισοδυναμεί με απενεργοποίηση. Ο χρήστης εξακολουθεί να βρίσκεται στη λίστα, αλλά δεν μπορεί πλέον να συνδεθεί.';
$lang['Email Adress'] = 'Διεύθυνση ηλεκτρονικού ταχυδρομείου';
$lang['Email'] = 'ΗΛΕΚΤΡΟΝΙΚΗ ΔΙΕΥΘΥΝΣΗ';
$lang['Edited on %s'] = 'Επεξεργάστηκε στο %s';
$lang['Edit photo #%s'] = 'Επεξεργασία φωτογραφίας #%s';
$lang['Edit guest user'] = 'Επεξεργασία επισκέπτη χρήστη';
$lang['Edit'] = 'Επεξεργασία';
$lang['During upload, if Piwigo detects the photo already exists, associate the existing photo to the destination album, without duplicating file'] = 'Κατά τη μεταφόρτωση, εάν το Piwigo εντοπίσει ότι η φωτογραφία υπάρχει ήδη, συσχετίστε την υπάρχουσα φωτογραφία με το λεύκωμα προορισμού, χωρίς να αντιγράψετε το αρχείο';
$lang['Drag and drop to reorder albums'] = 'Σύρετε και αποθέστε για αναδιάταξη λευκώματα';
$lang['Downloaded'] = 'Λήψη';
$lang['Download all activities'] = 'Λήψη όλων των δραστηριοτήτων';
$lang['Dissociate user from this group'] = 'Αποσύνδεση χρήστη από αυτήν την ομάδα';
$lang['Displays a banner to install or open the official Piwigo app'] = 'Εμφανίζει ένα banner για εγκατάσταση ή άνοιγμα της επίσημης εφαρμογής Piwigo';
$lang['Display'] = 'Εμφάνιση ';
$lang['Discover'] = 'Ανακαλύπτω';
$lang['Disallow comments for sub-albums'] = 'Απαγόρευση σχολίων για δευτερεύοντα λευκώματα';
$lang['Detect and avoid duplicates during upload'] = 'Εντοπίστε και αποφύγετε τα διπλότυπα κατά τη μεταφόρτωση';
$lang['Details'] = 'Λεπτομέριες';
$lang['Delete user'] = 'Διαγραφή χρήστη';
$lang['Delete these sizes'] = 'Διαγράψτε αυτά τα μεγέθη';
$lang['Delete them'] = 'Διαγράψτε τα';
$lang['Delete tags \{%s\}?'] = 'Διαγραφή ετικετών \{%s\};';
$lang['Delete tag "%s"?'] = 'Διαγραφή ετικέτας "%s";';
$lang['Delete album'] = 'Διαγραφή λεύκωμα ';
$lang['Delete orphan tags ?'] = 'Διαγραφή ορφανών ετικετών;';
$lang['Delete %s format ?'] = 'Διαγραφή μορφής %s ;';
$lang['Dec'] = 'Δεκ';
$lang['Deactivated'] = 'Απενεργοποιήθηκε';
$lang['Currently running version %s'] = 'Αυτήν τη στιγμή εκτελείται η έκδοση %s';
$lang['Current Version'] = 'Τρέχουσα έκδοση';
$lang['Created on %s'] = 'Δημιουργήθηκε σε %s';
$lang['Created'] = 'Δημιουργήθηκε';
$lang['Create a sub-album of "%s"'] = 'Δημιουργία υπο-λεύκωμα του "%s"';
$lang['Create a new album at root'] = 'Δημιουργήστε ένα νέο λεύκωμα στη root';
$lang['Compare mode'] = 'Λειτουργία σύγκρισης';
$lang['Compact View'] = 'Συμπαγής όψη';
$lang['Comments disallowed for sub-albums'] = 'Τα σχόλια δεν επιτρέπονται για τα δευτερεύοντα λευκώματα';
$lang['Comments allowed for sub-albums'] = 'Επιτρέπονται σχόλια για υπο-λευκώματα';
$lang['Close'] = 'Κλείσε';
$lang['Clear Selection'] = 'Καθαρλιστε τη Επιλογή';
$lang['Certification higher or equal to'] = 'Πιστοποίηση υψηλότερη ή ίση με';
$lang['Change Password'] = 'Άλλαξε κωδικό';
$lang['Choose which tag to merge these tags into'] = 'Επιλέξτε σε ποια ετικέτα θα συγχωνεύσετε αυτές τις ετικέτες';
$lang['Aug'] = 'Αύγ';
$lang['Can be shared by several individuals without conflict (they cannot change the password).'] = 'Μπορεί να γίνει κοινή χρήση από πολλά άτομα χωρίς διένεξη (δεν μπορούν να αλλάξουν τον κωδικό πρόσβασης).';
$lang['Cache size'] = 'Μέγεθος προσωρινής μνήμης';
$lang['Authorize comments'] = 'Εξουσιοδότηση σχολίων';
$lang['Associate User'] = 'Συνδεδεμμένος χρήστης';
$lang['Are you sure you want to unlock the gallery?'] = 'Είστε βέβαιοι ότι θέλετε να ξεκλειδώσετε τη γκαλερή;';
$lang['Are you sure you want to uninstall the plugin "%s"?'] = 'Είστε βέβαιοι ότι θέλετε να απεγκαταστήσετε το πρόσθετο"%s";';
$lang['Apr'] = 'Apr';
