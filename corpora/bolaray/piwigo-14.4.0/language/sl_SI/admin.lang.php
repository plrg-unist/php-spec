...
$lang['High definition enabled'] = 'Dovoli prenos';
...
$lang['%d checksums were added'] = '%d kontrolnih vst je bilo dodanih';
$lang['... or hide this link'] = '... ali skrij to povezavo';
$lang['Compute %d missing checksums'] = 'Iračunavanje %d mankajočih kontrolnih vsot';
$lang['Create a first album'] = 'Ustvari prvi abum';
$lang['Deletion in progress'] = 'Poteka izbris';
$lang['Display album date period'] = 'Prikaži časovno obdobje povezano z vsakim albumom npr. "od 12. do 18. Julija 2018"';
$lang['Display category date'] = 'Prikaži datum kategorije';
$lang['Piwigo requires an album to add photos.'] = 'Piwigo potrebuje album za dodajanje fotografij';
$lang['Some checksums are missing.'] = 'Manjkajo nekatere kontrolne vsote';
$lang['Synchronization in progress'] = 'Poteka sinhronizacija';
$lang['Visit'] = 'Obišči';
$lang['Welcome!'] = 'Dobrodošli';
$lang['With no checksum'] = 'Brez kontrolne vsote';
$lang['checksums to add'] = 'kontrolne vsote za dodati';
$lang['or'] = 'ali';
$lang['Tags \{%s\} succesfully deleted'] = 'Oznake \{%s\} uspešno izbrisane';
$lang['Tag "%s" succesfully deleted'] = 'OZnaka \"%s\" uspešno izbrisana';
...
$lang['Are you sure you want to update all extensions?'] = 'Ali ste prepričani, da želite posodobiti vse razširitve?';
$lang['Choose which tag to merge these tags into'] = 'Izberite, v katero oznako želite združiti te oznake';
$lang['Displays a banner to install or open the official Piwigo app'] = 'Prikaže pasico za namestitev ali odpiranje uradne aplikacije Piwigo';
$lang['The other tags will be removed'] = 'Ostale oznake bodo odstranjene';
$lang['This is already the default theme'] = 'To je že privzeta tema';
$lang['Videos'] = 'Video posnetki';
$lang['Tag Manager'] = 'Upravitelj oznak';
$lang['Merge'] = 'Združi';
$lang['Other'] = 'Drugo';
$lang['Storage'] = 'Shramba';
$lang['Tag "%s" created'] = 'Oznaka "%s" ustvarjena';
$lang['Edited on %s'] = 'Urejeno na %s';
$lang['File type: %s'] = 'Tip datoteke: %s';
$lang['Formats'] = 'Formati';
$lang['Group "%s" succesfully deleted'] = 'Skupina "%s" uspešno izbrisana';
$lang['Keep them'] = 'Obdrži jih';
$lang['%s file type'] = 'vrsta datoteke %s';
$lang['%s other tags available..'] = 'Na voljo je še %s oznak ..';
$lang['Are you sure you want to install the plugin "%s"?'] = 'Ali ste prepričani, da želite namestiti vtičnik "%s"?';
$lang['Created on %s'] = 'Ustvarjeno %s';
$lang['Are you sure you want to delete group "%s"?'] = 'Ali ste prepričani, da želite izbrisati skupino "%s"?';
$lang['Are you sure you want to delete the language "%s"?'] = 'Ali ste prepričani, da želite izbrisati jezik "%s"?';
$lang['Are you sure you want to delete the plugin "%s"?'] = 'Ali ste prepričani, da želite izbrisati vtičnik "%s"?';
$lang['Are you sure you want to delete the theme "%s"?'] = 'Ali ste prepričani, da želite izbrisati temo "%s"?';
$lang['Yes, I am sure'] = 'Da, prepričan sem';
$lang['Yes, delete'] = 'Da, izbriši';
$lang['You don\'t have access to this photo'] = 'Nimate dostopa do te fotografije';
$lang['in gallery'] = 'v galeriji';
$lang['no photo'] = 'ni fotografije';
$lang['Name is already taken'] = 'Ime je že zasedeno';
$lang['No albums found'] = 'Najti ni bilo mogoče nobenega albuma';
$lang['No tag found'] = 'Najdena ni nobena oznaka';
$lang['No, I have changed my mind'] = 'Ne, premislil sem se';
$lang['Open in gallery'] = 'Odpri v galeriji';
$lang['Page Visited'] = 'Stran obiskana';
$lang['Page Visited in %s'] = 'Stran obiskana v %s';
$lang['Please upgrade your PHP version before any update.'] = 'Pred kakršno koli posodobitvijo nadgradite različico PHP.';
$lang['Portraits'] = 'Portreti';
$lang['Posted %s'] = 'Objavljeno %s';
$lang['Promote mobile app on mobile devices'] = 'Promovirajte mobilno aplikacijo v mobilnih napravah';
$lang['Requires PHP %s'] = 'Zahteva PHP %s';
$lang['Search tips'] = 'Nasveti za iskanje';
$lang['Select'] = 'Izberi';
$lang['Average last 12 months'] = 'Povprečje zadnjih 12 mesecev';
$lang['Clear Selection'] = 'Počisti izbor';
$lang['Compare mode'] = 'Primerjalni način';
$lang['Delete album'] = 'Izbriši album';
$lang['Delete them'] = 'Izbriši jih';
$lang['Group added'] = 'Skupina dodana';
$lang['Group renamed'] = 'Skupina preimenovana';
$lang['Activity peak in the last weeks'] = 'Vrhunec aktivnosti v zadnjih tednih';
$lang['Are you sure you want to delete all sizes?'] = 'Ali ste prepričani, da želite izbrisati vse velikosti?';
$lang['Are you sure you want to lock the gallery?'] = 'Ali ste prepričani, da želite zakleniti galerijo?';
$lang['Are you sure you want to delete the user "%s"?'] = 'Ali ste prepričani, da želite izbrisati uporabnika "%s"?';
$lang['Are you sure you want to delete this site?'] = 'Ali ste prepričani, da želite izbrisati to spletno mesto?';
$lang['Are you sure you want to delete this theme?'] = 'Ali ste prepričani, da želite izbrisati to temo?';
$lang['Are you sure you want to delete this?'] = 'Ali ste prepričani, da želite to izbrisati?';
$lang['%d Activities'] = '%d Aktivnosti';
$lang[' (copy %s)'] = '(kopiraj %s)';
$lang[' (copy)'] = '(kopiraj)';
$lang['%d Activity'] = '%d Dejavnosti';
$lang['%d photos'] = '%d Slike';
$lang['%d sub-albums'] = '%d pod albumi';
...
$lang['The %d tags on this page are selected'] = 'Izbrane so oznake %d na tej strani';
$lang['Set as group for new users'] = 'Nastavitev kot skupino za nove uporabnike';
...
$lang['User associated'] = 'Pridruženi uporabnik';
$lang['Manage users with user manager'] = 'Upravljanje uporabnikov z upraviteljem uporabnikov';
$lang['Search albums'] = 'Iskanje albumov';
$lang['Select all %d tags'] = 'Izberite vse oznake %d';
$lang['Album search tool'] = 'Orodje za iskanje albumov';
$lang['Associate User'] = 'Pridruženi uporabnik';
$lang['Dissociate user from this group'] = 'Izvleci uporabnika iz te skupine';
$lang['Manage album photos'] = 'Upravljanje fotografij albuma';
$lang['Manage sub-albums'] = 'Upravljanje pod albumov';
$lang['No plugins found'] = 'Vtičniki niso najdeni';
$lang['Refresh thumbnail'] = 'Osveži sličice';
$lang['Selection mode'] = 'Način izbire';
$lang['You have %s inactive plugins'] = 'Imate %s neaktivnih vtičnikov';
$lang['and %s others'] = 'in %s drugih';
$lang['At least 2 selected tags are needed to merge'] = 'Za združitev sta potrebni vsaj 2 izbrani oznaki';
$lang['Cache'] = 'Predpomnilnik';
$lang['in administration'] = 'v administraciji';
$lang['Review'] = 'Pregled';
$lang['Show inactive plugins'] = 'Pokaži neaktivne vtičnike';
$lang['<b>1</b> album found'] = '<b>1</b> najden album';
$lang['<b>%d</b> albums found'] = '<b>%d</b> najdenih albumov';
$lang['<b>%d</b> tag found'] = '<b>%d</b> najdena oznaka';
...
$lang['right now'] = 'prav zdaj';
$lang['never calculated'] = 'nikoli izračunano';
$lang['move'] = 'premakniti';
$lang['months ago'] = 'pred meseci';
$lang['login'] = 'prijava';
$lang['logout'] = 'odjava';
$lang['edit'] = 'uredi';
$lang['deletion'] = 'izbris';
$lang['calculated'] = 'izračunano';
$lang['between %s and %s'] = 'med %s in %s';
$lang['add'] = 'dodaj';
$lang['action successfully performed.'] = 'dejanje uspešno izvedeno.';
$lang['Your selection'] = 'Tvoja izbira';
$lang['Webmaster status required'] = 'Zahtevan status skrbnika';
$lang['User updated'] = 'Uporabnik posodobljen';
$lang['Theme'] = 'Tema';
$lang['Show sub-albums'] = 'Prikaži pod-albume';
$lang['Show'] = 'Prikaži';
$lang['Selected user'] = 'Izbrani uporabnik';
$lang['Root'] = 'Koren (Root)';
$lang['Restored'] = 'Obnovljeno';
$lang['Plugin "%s" has been activated!'] = 'Vtičnik "%s" je bil aktiviran! ';
$lang['Plugin "%s" deleted!'] = 'Vtičnik "%s" je izbrisan!';
$lang['Photos per page'] = 'Slik na strani';
$lang['No access to administration, can see private content with appropriate permissions.'] = 'Brez dostopa do administracije, lahko si ogledate zasebno vsebino z ustreznimi dovoljenji.';
$lang['New user added'] = 'Novi uporabnik je dodan';
$lang['Name field must not be empty'] = 'Polje z imenom ne sme biti prazno';
$lang['Locked albums are disabled for maintenance. Only administrators can view them in the gallery. Lock this album will also lock his Sub-albums'] = 'Zaklenjeni albumi so onemogočeni zaradi vzdrževanja. V galeriji si jih lahko ogledajo samo skrbniki. Zaklepanje tega albuma bo zaklenilo tudi njegove pod-albume';
$lang['Last visit'] = 'Zadnji obisk';
$lang['Hide sub-albums'] = 'Skrij pod-albume';
$lang['Has access to all administration functionnalities. Can manage both configuration and content.'] = 'Ima dostop do vseh administrativnih funkcij. Lahko upravlja tako konfiguracijo kot vsebino.';
$lang['Has access to administration. Can only manage content: photos/albums/users/tags/groups.'] = 'Ima dostop do administracije. Lahko upravlja samo vsebino: fotografije/albumi/uporabniki/oznake/skupine.';
$lang['Equivalent to deactivation. The user is still in the list, but can no longer log in.'] = 'Enakovredno deaktivaciji. Uporabnik je še vedno na seznamu, vendar se ne more več prijaviti.';
$lang['Email Adress'] = 'E-mail naslov';
$lang['Email'] = 'E-mail';
$lang['Edit photo #%s'] = 'Uredi sliko #%s';
$lang['Edit'] = 'Uredi';
$lang['Drag and drop to reorder albums'] = 'Povlecite in spustite, da preuredite albume';
$lang['Download all activities'] = 'Prenesite vse dejavnosti';
$lang['Change Password'] = 'Spremeni Geslo';
$lang['Apply to direct sub-albums'] = 'Uporabite za neposredne pod-albume';
$lang['%d users logged in'] = '%d uporabnikov prijavljenih';
$lang['%d users logged out'] = '%d uporabnikov odjavljenih';
$lang['%d users edited'] = '%d uporabnikov urejenih';
$lang['%s lines'] = '%s vrstice';
$lang['%s line'] = '%s vrstica';
$lang['%d users added'] = '%d uporabniki dodani';
$lang['%d user logged out'] = '%d uporabnik odjavljen';
$lang['%d user logged in'] = '%d uporabnik prijavljen';
$lang['%d user edited'] = '%d uporabnik urejen';
$lang['%d user added'] = '%d uporabnik dodan';
$lang['%d tags moved'] = '%d oznake premaknjene';
$lang['%d tags edited'] = '%d oznake urejene';
$lang['%d tag moved'] = '%d oznaka premaknjena';
$lang['%d tags added'] = '%d oznake dodane';
$lang['%d tags deleted'] = '%d oznake izbrisane';
$lang['%d tag edited'] = '%d oznaka urejena';
$lang['%d tag deleted'] = '%d oznaka izbrisana';
$lang['%d tag added'] = '%d oznaka dodana';
$lang['%d photos moved'] = '%d slike premaknjene';
$lang['%d photos edited'] = '%d slike urejene';
$lang['%d photos deleted'] = '%d slike izbrisane';
$lang['%d photos added'] = '%d slike so dodane';
$lang['%d photo moved'] = '%d slika premaknjena';
$lang['%d photo edited'] = '%d slika urejena';
$lang['%d photo deleted'] = '%d slika izbrisana';
$lang['%d photo added'] = '%d slika dodana';
$lang['Tile View'] = 'Pogled na ploščice';
$lang['Select groups or type them'] = 'Izberite skupine ali jih vnesite';
$lang['Select an album... or type it!'] = 'Izberite album ... ali ga vnesite!';
$lang['Line View'] = 'Pogled vrstice';
$lang['Filters'] = 'Filtri';
$lang['Registered'] = 'Registriran';
$lang['Manage users'] = 'Upravljajte uporabnike';
$lang['Generate random password'] = 'Ustvari naključno geslo';
$lang['Delete user'] = 'Izbriši uporabnika';
$lang['to'] = 'za';
$lang['Sep'] = 'Sep';
$lang['Oct'] = 'Okt';
$lang['Mar'] = 'Mar';
$lang['May'] = 'Maj';
$lang['Nov'] = 'Nov';
$lang['Edit guest user'] = 'Uredi gostujočega uporabnika';
$lang['Feb'] = 'Feb';
$lang['Jun'] = 'Jun';
$lang['Jul'] = 'Jul';
$lang['Jan'] = 'Jan';
$lang['Language'] = 'Jezik';
$lang['Compact View'] = 'Kompakten pogled';
$lang['Close'] = 'Zapri';
$lang['Apply to the whole hierarchy'] = 'Uporabite za celotno hierarhijo';
$lang['Apply an automatic order to root albums'] = 'Uporabite avtomatsko naročilo za korenske(root) albume';
$lang['<b>%d+</b> albums found, try to refine the search'] = '<b>%d+</b> najdenih albumov, poskusite izboljšati iskanje';
$lang['%s status is required to edit parameters.'] = '%s status je potreben za urejanje parametrov.';
$lang['%s plugin found'] = '<b>%s</b> vtičnik najden';
$lang['%s plugins found'] = '<b>%s</b> vtičniki najdeni';
$lang['Advanced filters'] = 'Napredni filtri';
$lang['Activity'] = 'Aktivnost';
$lang['Activated plugin list'] = 'Seznam aktiviranih vtičnikov';
$lang['Delete these sizes'] = 'Izbrišite te velikosti';
$lang['Dec'] = 'Dec';
$lang['Can be shared by several individuals without conflict (they cannot change the password).'] = 'Lahko ga deli več posameznikov brez konflikta (ne morejo spremeniti gesla). ';
$lang['Aug'] = 'Avg';
$lang['Apr'] = 'Apr';
$lang['Cache size'] = 'Velikost predpomnilnika';
$lang['Deactivated'] = 'Deaktivirano';
$lang['Activated'] = 'Aktivirano';
$lang['%s MB'] = '%s MB';
$lang['Add a new user'] = 'Dodajte novega uporabnika';
$lang['Add User'] = 'Dodaj uporabnika';
$lang['Activity time from'] = 'Čas aktivnosti od';
$lang['No plugin activated'] = 'Noben vtičnik ni aktiviran ';
$lang['Synchronization'] = 'Sinhronizacija ';
$lang['Users not logged in will have these settings applied, these settings are used by default for new users'] = 'Za uporabnike, ki niso prijavljeni, bodo te nastavitve uporabljene, te nastavitve se privzeto uporabljajo za nove uporabnike';
$lang['%d groups moved'] = '%d skupine premaknjene';
$lang['%d groups edited'] = '%d skupine urejene';
$lang['%d groups deleted'] = '%d skupine izbrisane';
$lang['%d groups added'] = '%d dodane skupine';
$lang['%d group moved'] = '%d skupina premaknjena';
$lang['%d group edited'] = '%d skupina urejena';
$lang['%d group deleted'] = '%d skupina izbrisana';
$lang['%d group added'] = '%d skupina dodana';
$lang['%d albums deleted'] = '%d albumi izbrisani';
$lang['%d albums edited'] = '%d urejeni albumi';
$lang['%d albums added'] = '%d dodani albumi';
