...
$lang['No photos selected, no actions possible.'] = 'Nenhuma foto seleccionada, Impossível realizar acção.';
$lang['None'] = 'Nenhuma';
...
$lang['No groups selected, no actions possible.'] = 'Não existe grupo selecionado, não é possivel qualquer ação';
...
$lang['No users selected, no actions possible.'] = 'Sem utilizador selecionado não é possivel qualquer ação';
...
$lang['Webmaster status required'] = 'Necessários status do webmaster';
$lang['You have %d orphan tags %s'] = 'Você tem %d etiquetas orfãs %s';
$lang['You have %s1 orphan : %s2'] = 'Você tem %s1 orfão: %s2';
$lang['action successfully performed.'] = 'ação executada com êxito.';
...
$lang['Manage users with user manager'] = 'Gerenciar utilizadores com o gerenciador de utilizadores';
...
$lang['Photos per page'] = 'Fotos por página';
$lang['Picture to associate formats with'] = 'Imagem para lhe associar formatos';
$lang['Piwigo is also on mobile.'] = 'Piwigo também está no celular.';
$lang['No tag found'] = 'tiqueta não encontrada';
$lang['Nov'] = 'Nov';
$lang['Oct'] = 'Out';
$lang['Other'] = 'Outro';
$lang['Delete %s format ?'] = 'Excluir o formato %s?';
$lang['Delete tag "%s"?'] = 'Excluir etiqueta "%s"?';
$lang['Delete tags \{%s\}?'] = 'Excluir etiquetas \{%s\}?';
$lang['Delete these sizes'] = 'Excluir esses tamanhos';
$lang['File type: %s'] = 'Tipo de arquivo: %s';
$lang['Group "%s" succesfully deleted'] = 'Grupo "%s" excluído com êxito';
$lang['Group(s) \{%s1\} succesfully merged into "%s2"'] = 'Grupo(s) \{%s1\} fundido(s) com sucesso em "%s2"';
$lang['Groups \{%s\} succesfully deleted'] = 'Grupos \{%s\} excluídos com êxito';
$lang['Has access to administration. Can only manage content: photos/albums/users/tags/groups.'] = 'Tem acesso à administração. Só pode gerir conteúdos: fotos/álbuns/utilizadores/etiquetas/grupos.';
$lang['Has access to all administration functionnalities. Can manage both configuration and content.'] = 'Tem acesso a todas as funcionalidades da administração. Pode gerenciar a configuração e o conteúdo.';
$lang['Hide sub-albums'] = 'Ocultar sub-albuns';
$lang['Install Piwigo on mobile'] = 'Instalar extensão no movel';
$lang['Keep them'] = 'Guarde-os';
$lang['Latest Piwigo news'] = 'Últimas notícias Piwigo';
$lang['Locked albums are disabled for maintenance. Only administrators can view them in the gallery. Lock this album will also lock his Sub-albums'] = 'Os álbuns bloqueados estão desativados para manutenção. Apenas os administradores podem visualizá-los na galeria. Bloquear este álbum também bloqueará seus sub-álbuns';
$lang['Manage album photos'] = 'Gerenciar fotos do album';
$lang['Delete album'] = 'Apagar album';
$lang['Delete orphan tags ?'] = 'Apagar etiquetas orfãs';
$lang['Delete them'] = 'Apagá-los';
$lang['Feb'] = 'Fev';
$lang['Filters'] = 'Filtros';
$lang['Formats'] = 'Formatos';
$lang['Generate random password'] = 'Gerar senha aleatória';
$lang['Global Gallery Actions'] = 'Ações da Galeria Global';
$lang['Group added'] = 'Grupo adicionado';
$lang['Group renamed'] = 'Grupo renomeado';
$lang['Delete user'] = 'Apagar utilizador';
$lang['Download all activities'] = 'Descarrega de  todas as atividades';
$lang['Downloaded'] = 'Descarregado';
$lang['Drag and drop to reorder albums'] = 'Arrastar e soltar para reordenar álbuns';
$lang['Edit'] = 'Editar';
$lang['Edit guest user'] = 'Editar utilizador convidado';
$lang['Edit photo #%s'] = 'Editar foto #%s';
$lang['Edited on %s'] = 'Editado em %s';
$lang['Email'] = 'Email';
$lang['Email Adress'] = 'Direção de Email';
$lang['Equivalent to deactivation. The user is still in the list, but can no longer log in.'] = 'Equivalente à desativação. O utilizador ainda está na lista, mas não pode mais fazer login.';
$lang['Error when trying to detect formats'] = 'Erro ao tentar detetar formatos';
$lang['Extensions'] = 'Extensões';
$lang['%d checksums were added'] = '%d somas de verificação foram adicionadas';
$lang['Are you sure you want to lock the gallery?'] = 'Tem a certeza de que quer bloquear a galeria?';
$lang['Are you sure you want to restore the plugin "%s"?'] = 'Tem certeza de que deseja restaurar a extensão "%s"?';
$lang['Are you sure you want to restore this plugin?'] = 'Tem certeza de que deseja restaurar esta extensão?';
$lang['Are you sure you want to restore to default settings?'] = 'Tem certeza de que deseja restaurar as configurações padrão?';
$lang['Are you sure you want to uninstall the plugin "%s"?'] = 'Tem certeza de que deseja desinstalar a extensão "%s"?';
$lang['Are you sure you want to unlock the gallery?'] = 'Tem a certeza de que quer desbloquear a galeria?';
$lang['Are you sure you want to update all extensions?'] = 'Tem certeza de que deseja atualizar todas as extensões?';
$lang['Associate User'] = 'Associar utilizador';
$lang['At least 2 selected tags are needed to merge'] = 'Pelo menos 2 etiquetas selecionadas são necessárias para inserir';
$lang['Aug'] = 'Ago';
$lang['Average last 12 months'] = 'Média nos últimos 12 meses';
$lang['Cache'] = 'Cache';
$lang['Cache size'] = 'Tamanho da Cache';
$lang['Can be shared by several individuals without conflict (they cannot change the password).'] = 'Pode ser partilhado por várias pessoas sem conflito (Elas não podem alterar a palavra-passe).';
$lang['Compute %d missing checksums'] = 'Calcular %d somas de verificação esquecidas';
...
$lang['Dec'] = 'Dez';
$lang['Are you sure you want to delete the user "%s"?'] = 'Está seguro de que deseja apagar o utilizador "%s"?';
$lang['Are you sure you want to delete this site?'] = 'Está seguro de que deseja apagar este sitio?';
$lang['Are you sure you want to delete this theme?'] = 'Está seguro de que deseja apagar este tema?';
$lang['Are you sure you want to delete this?'] = 'Está seguro de que deseja apagar isto?';
$lang['Are you sure you want to install the plugin "%s"?'] = 'Está seguro de que deseja apagar a extensão "%s"?';
$lang['Merge'] = 'Inserir';
$lang['Piwigo core'] = 'Núcleo Piwigo';
$lang['Root'] = 'Raiz';
$lang['Tile View'] = 'Vista de mosaico';
$lang['Unset as group for new users'] = 'Não definir como grupo para novos utilizadores';
$lang['Upload Formats'] = 'Carregar formatos';
$lang['User "%s" dissociated from this group'] = 'Utilizador "%s" dissociado deste grupo';
$lang['User associated'] = 'Utilizador associado';
$lang['Purge Cache'] = 'Limpar cache';
$lang['Rating greater than'] = 'Classificação superior a';
$lang['Refresh thumbnail'] = 'Atualizar miniatura';
$lang['Rename "%s"'] = 'Renomear "%s"';
$lang['Search tips'] = 'Dicas de pesquisa';
$lang['Select all %d tags'] = 'Selecione todas as %d etiquetas';
$lang['Some checksums are missing.'] = 'Esquecidas algumas somas de verificação.';
$lang['Tag "%s" created'] = 'Tag "%s" criada';
$lang['Tag "%s" succesfully deleted'] = 'Etiqueta \"%s\" excluída com êxito';
$lang['Tag(s) \{%s1\} succesfully merged into "%s2"'] = '\{%s1\} etiquetas inseridas com sucesso em "%s2"';
$lang['The original picture will be detected with the filename (without extension).'] = 'A imagem original será detetada com o nome do arquivo (sem extensão).';
...
$lang['This albums is already in related categories list'] = 'Este album já está na lista de álbuns relacionados';
$lang['This is already the default theme'] = 'Este já é o tema padrão';
$lang['This photo is an orphan'] = 'Esta foto é órfã';
$lang['This picture is physically linked to this album, you can\'t dissociate them'] = 'Esta imagem está fisicamente ligada a este álbum, você não pode dissociá-los.';
$lang['Synchronization in progress'] = 'Sincronização em curso';
$lang['Tag "%s1" renamed in "%s2"'] = 'Etiqueta \"%s1\" renomeada em \"%s2\"';
$lang['Tag Manager'] = 'Gestor de etiquetas';
$lang['Tag name'] = 'Nome da etiqueta';
$lang['Tags \{%s\} succesfully deleted'] = '\{%s\} etiquetas excluídas com sucesso';
$lang['The %d tags on this page are selected'] = 'Selecionadas %d etiquetas nesta página';
$lang['The best is to have them made automatically on a regular basis.'] = 'O melhor é tê-las feitas automaticamente numa base regular.';
$lang['Registered'] = 'Registado';
$lang['Requires PHP %s'] = 'Requer PHP %s';
$lang['Restored'] = 'Restaurado';
$lang['Select an album... or type it!'] = 'Selecione um album... ou digite!';
$lang['Select groups or type them'] = 'Selecione grupos ou digite-os';
$lang['Selected user'] = 'Utilizador selecionado';
$lang['Selection mode'] = 'Modo de seleção';
$lang['Sep'] = 'Set';
$lang['Showing %s users out of %s'] = 'Mostrando %s utilizadores de %s';
$lang['Storage'] = 'Armazenamento';
$lang['If anything bad happens during the update, you would be able to restore a backup.'] = 'Se algo ruim acontecer durante a atualização, você poderá restaurar um backup.';
$lang['Installed on %s, %s'] = 'Instalado em %s, %s';
$lang['Last revision date is newer than'] = 'A data da última revisão é mais recente do que';
$lang['Line View'] = 'Vista de linha';
$lang['Manage sub-albums'] = 'Gerir sub-albuns';
$lang['Manage users'] = 'Gerir utilizadores';
$lang['No access to administration, can see private content with appropriate permissions.'] = 'Sem acesso à administração, pode ver conteúdo privado com as devidas permissões.';
$lang['No plugin activated'] = 'Nenhuma extensão ativada';
$lang['No plugins found'] = 'Não existem extensões';
$lang['No research in progress'] = 'Nenhuma busca em curso';
$lang['On %d rating(s)'] = 'Em %d classificação(ões)';
$lang['Page Visited in %s'] = 'Página visitada em %s';
$lang['Please upgrade your PHP version before any update.'] = 'Por favor, atualize sua versão PHP antes de qualquer atualização.';
$lang['Plugin "%s" deleted!'] = 'Plugin "%s" excluído!';
$lang['Portraits'] = 'Retratos';
$lang['Posted %s'] = 'Colocado %s';
$lang['Promote mobile app on mobile devices'] = 'Promova a aplicação móvel em dispositivos móveis';
$lang['Purge Actions'] = 'Ações de limpeza';
$lang['Detect and avoid duplicates during upload'] = 'Detetar e evitar duplicados durante o carregamento';
$lang['This album is currently locked, visible only to administrators.'] = 'Este album está fechado,visivel apenas pelos administradores';
$lang['%d including sub-albums'] = '%d incluindo sub-albuns';
$lang['Activate button "%s"'] = 'Ativar botão "%s"';
$lang['All admins'] = 'Todos os Administradores';
$lang['Allow comments for sub-albums'] = 'Permitir comentários nos sub-albuns';
$lang['Authorize comments'] = 'Autorizar comentários';
$lang['Comments allowed for sub-albums'] = 'Comentários permitidos nos sub-albuns';
$lang['Comments disallowed for sub-albums'] = 'Comentários desativados para sub-albuns';
$lang['Created'] = 'Criado';
$lang['Disallow comments for sub-albums'] = 'Desativar comentários para sub-albuns';
$lang['Locked album'] = 'Album fechado';
$lang['Modified'] = 'Modificado';
$lang['Only admins in a specific group'] = 'Somente admins num grupo especifico';
