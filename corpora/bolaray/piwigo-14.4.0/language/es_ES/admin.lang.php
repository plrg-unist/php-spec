...
$lang['%d in whole branch'] = '%d en la rama entera';
$lang['%d including sub-albums'] = '%d incluyendo los sub-álbumes';
$lang['Activate button "%s"'] = 'Activar el botón "%s"';
$lang['All admins'] = 'Todos los administradores';
$lang['Allow comments for sub-albums'] = 'Permitir comentarios para los sub-álbumes';
$lang['Authorize comments'] = 'Autorizar comentarios';
$lang['Comments allowed for sub-albums'] = 'Comentarios permitidos para los sub-álbumes';
$lang['Comments disallowed for sub-albums'] = 'Comentarios no permitidos para los sub-álbumes';
$lang['Created'] = 'Creado';
$lang['Detect and avoid duplicates during upload'] = 'Detectar y evitar duplicados durante la subida';
$lang['Disallow comments for sub-albums'] = 'No permitir comentarios para los sub-álbumes';
$lang['During upload, if Piwigo detects the photo already exists, associate the existing photo to the destination album, without duplicating file'] = 'Durante la subida, si Piwigo detecta que la foto ya existe, asociará la foto existente al álbum de destino, sin duplicar el archivo.';
$lang['Locked album'] = 'Álbum bloqueado';
$lang['Modified'] = 'Modificado';
$lang['Only admins in a specific group'] = 'Sólo los administradores pertenecientes a un grupo específico';
$lang['Put at the root'] = 'Poner en la raíz';
