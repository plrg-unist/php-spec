...
$lang['%d in whole branch'] = '%d v celej vetve';
$lang['%d including sub-albums'] = '%d vrátane podalbumov';
$lang['Activate button "%s"'] = 'Aktivovať tlačidlo "%s"';
$lang['All admins'] = 'Všetci správcovia';
$lang['Allow comments for sub-albums'] = 'Povoliť komentáre pre podalbumy';
$lang['Authorize comments'] = 'Autorizovať komentáre';
$lang['Comments allowed for sub-albums'] = 'Komentáre sú povolené pre podalbumy';
$lang['Comments disallowed for sub-albums'] = 'Komentáre nie sú povolené pre podalbumy';
$lang['Created'] = 'Vytvorené';
$lang['Detect and avoid duplicates during upload'] = 'Zistiť a vyhnúť sa duplikátom počas nahrávania';
$lang['Disallow comments for sub-albums'] = 'Zakázať komentáre pre podalbumy';
$lang['During upload, if Piwigo detects the photo already exists, associate the existing photo to the destination album, without duplicating file'] = 'Ak Piwigo počas nahrávania zistí, že fotografia už existuje, priraďte existujúcu fotografiu k cieľovému albumu bez duplikovania súboru';
$lang['Locked album'] = 'Zamknutý album';
$lang['Modified'] = 'Upravené';
$lang['Only admins in a specific group'] = 'Iba správcovia v konkrétnej skupine';
$lang['Put at the root'] = 'Vložte do koreňa';
$lang['Remove thumbnail'] = 'Odstrániť miniatúru';
