...
if (mysql_num_rows($result) == 0) {
    die("I'm sorry, there isn't any paper with that id");
}
...
if (is_admin()) {
    print "<a href='editpaper.php?paper_id=$id'>(Edit this paper)</a><br>";
}
...
while ($row = mysql_fetch_row($result2)) {
    ...
    if (!strcmp($row[1], "application/xpdf") || !strcmp($row[1], "application/pdf")) {
        print "<td><img src='images/pdf.gif'></td>";
    }
}
