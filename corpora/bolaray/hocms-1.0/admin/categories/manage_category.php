...
<div class="container-fluid">
	<form action="" id="category-form">
		...
		<div class="form-group">
			<label for="fee" class="control-label">Fixed Fee</label>
			<input name="fee" id="fee" type="number" step="any" class="form-control form-control-sm form-control-border" value="<?php echo isset($fee) ? $fee : ''; ?>" required>
		</div>
		<div class="form-group">
