...
function process_metar($metar)
{
    ...
    for ($i = 0; $i < $num_parts; $i++) {
        ...
        if (ereg('RMK|TEMPO|BECMG', $part)) {
             ...
             * gmdate()
             */
            $decoded_metar['time'] = gmmktime(
                $regs[2] + $weather_offset,
                $regs[3],
                0,
                gmdate('m'),
                $regs[1],
            ...
            '^(-|\+|VC)?(TS|SH|FZ|BL|DR|MI|BC|PR|RA|DZ|SN|SG|GR|' .
            ...
            '^(VV|FEW|SCT|BKN|OVC)([0-9]{3})(CB|TCU)?$',
            $part,
            $regs
        )) {
     ...
     * Relative humidity
     */
    $decoded_metar['rel_humidity'] = number_format(pow(
        10,
