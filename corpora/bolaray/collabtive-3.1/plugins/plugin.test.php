...
class test implements collabtivePlugin
{
    ...
    public static function activateSecondHook($source, Smarty_Internal_Template $localTemplateObj)
    {
     ...
     * @param obj $localTemplateObj Object representing the template
     */
    public static function getMainTemplate($params, Smarty_Internal_Template $templateObj)
    {
        global $template;
