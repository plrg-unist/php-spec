...
class datei
{
     ...
     * @return bool
     */
    public function addFolder($parent, $project, $folder, $desc)
    {
        global $conn, $mylog;
     ...
     * @return bool
     */
    public function deleteFolder($id, $project)
    {
        global $conn, $mylog;
     ...
     */
    public function getSubFolders($parent)
    {
        global $conn;
     ...
     * @return array $folders
     */
    public function getProjectFolders($project, $parent = 0)
    {
        global $conn;
     ...
     * @return array $folders
     */
    public function getAllProjectFolders($project)
    {
        global $conn;
     ...
     */
    public function getAbsolutePathName($folder)
    {
        global $conn;
        if ($folder['parent'] == 0) {
            return "/" . $folder['name'];
     ...
     * @return bool
     */
    public function uploadAsync($name, $tmp_name, $typ, $size, $ziel, $project, $folder = 0)
    {
        global $mylog;
        $visible = "";
        $visstr = "";
     ...
     * @return bool
     */
    public function edit($id, $title, $desc, $tags)
    {
        global $conn, $mylog;
     ...
     * @return bool
     */
    public function loeschen($datei)
    {
        global $conn, $mylog;
        $datei = (int)$datei;
     ...
     */
    public function getProjectFiles($id, $limit = 5000, $folder = "", $offset = 0)
    {
        global $conn;
    ...
    public function getJsonProjectFiles($id, $limit = 5000, $folder = 0, $offset = 0)
    {
        global $conn;
    ...
    public function countJsonProjectFiles($id, $folder = 0)
    {
        global $conn;
     ...
     * @return bool $insid
     */
    public function add_file($name, $desc, $project, $milestone, $datei, $type, $title = " ", $folder = 0, $visstr = "")
    {
        global $conn;
     ...
     */
    public function encryptFile($filename, $key)
    {
     ...
     */
    public function decryptFile($filename, $key)
    {
        include_once(CL_ROOT . "/include/phpseclib/Crypt/AES.php");
        $cipher = new Crypt_AES(); // could use CRYPT_AES_MODE_CBC
        $cipher->setPassword($key);
