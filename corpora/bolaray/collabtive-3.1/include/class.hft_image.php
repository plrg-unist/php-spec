...
class hft_image
{
    ...
    public $image_original_type_code;
    public $image_original_type_abbr;
    public $image_original_html_sizes;
    ...
    public function hft_image($file_original)
    {
    ...
    public function set_parameters($jpeg_quality="90", $use_gd2=true)
    {
    ...
    public function resize($desired_width, $desired_height, $mode="0")
    {
        ...
        if($this->use_gd2) {
            if(function_exists("imagecopyresampled")) {
                $res = imagecopyresampled(
                    ...
                    0,			//source coord
                    $new_width,
                    $new_height, //dest sizes
                    $this->image_original_width,
                    $this->image_original_height // src sizes
