...
class pluginManager
{
     ...
     */
    public function loadPlugin($thePlugin)
    {
    ...
    */
    public function setPluginState($pluginName, $pluginState)
    {
        /*
     ...
     */
    public function registerPlugin(array $templateTags, $pluginClassName)
    {
        global $template;
     ...
     */
    public function registerHook(array $filterFunctionNames)
    {
        global $template;
