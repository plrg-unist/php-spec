...
class settings
{
     ...
     * @return bool
     */
    public function editSettings($name, $subtitle, $locale, $timezone, $dateformat, $templ, $theme, $rssuser, $rsspass)
    {
        global $conn;
     ...
     * @return bool
     */
    public function editMailsettings($onoff, $mailfrom, $mailfromname, $method, $mailhost, $mailuser, $mailpass)
    {
        global $conn;
        // This is an artifact of refactoring to a key/value table for the settings
    ...
    /*
       ...
       * @return array $templates
    */
    public function getThemes($template)
    {
