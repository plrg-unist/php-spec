...
class milestone
{
     ...
     * @return bool
     */
    public function add($project, $name, $desc, $start, $end, $status = 1)
    {
        global $conn, $mylog;
     ...
     * @return bool
     */
    public function edit($id, $name, $desc, $start, $end)
    {
        global $conn, $mylog;
        $id = (int)$id;
     ...
     * @return bool
     */
    public function assign($milestone, $user)
    {
        global $conn, $mylog;
     ...
     * @return bool
     */
    public function deassign($milestone, $user)
    {
        global $conn, $mylog;
        $milestone = (int)$milestone;
        $user = (int)$user;
     ...
     */
    public function getMilestones($status = 1, $lim = 100)
    {
        global $conn;
        $status = (int)$status;
        $lim = (int)$lim;
     ...
     */
    public function getDoneProjectMilestones($project)
    {
        global $conn;
        $project = (int)$project;
     ...
     */
    public function getLateProjectMilestones($project, $lim = 100)
    {
        global $conn;
        $project = (int)$project;
        $lim = (int)$lim;
     ...
     * @return array $milestones Dateils of the late milestones
     */
    public function getUpcomingProjectMilestones($project, $lim = 100)
    {
        global $conn;
        $project = (int)$project;
        $lim = (int)$lim;
     ...
     */
    public function getAllProjectMilestones($project, $lim = 100)
    {
        global $conn;
        $project = (int)$project;
        $lim = (int)$lim;
     ...
     * @return array $milestones Details of the milestones
     */
    public function getProjectMilestones($project, $lim = 100)
    {
        global $conn;
        $project = (int)$project;
        $lim = (int)$lim;
     ...
     * @return array $milestones Details of the milestones
     */
    public function getTodayProjectMilestones($project, $lim = 100)
    {
        global $conn;
        $project = (int)$project;
        $lim = (int)$lim;
     ...
     * @return array $milestones Details of the milestones
     */
    public function getTodayMilestones($m, $y, $d, $project = 0)
    {
        global $conn;
        $m = (int)$m;
        $y = (int)$y;
     ...
     */
    public function getMilestoneTasklists($milestone)
    {
        global $conn;
        $milestone = (int)$milestone;
     ...
     */
    public function formatdate(array $milestones)
    {
        $cou = 0;
