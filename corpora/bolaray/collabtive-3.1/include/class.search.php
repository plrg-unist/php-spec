...
class search
{
    ...
    public function dosearch($query, $project = 0)
    {
        if (empty($query)) {
            return false;
        }
    ...
    public function searchMilestones($query, $project = 0)
    {
        global $conn;
        $project = (int) $project;
    ...
    public function searchMessage($query, $project = 0)
    {
        global $conn;
        $project = (int) $project;
    ...
    public function searchTasks($query, $project = 0)
    {
        global $conn;
        $project = (int) $project;
    ...
    public function searchFiles($query, $project = 0)
    {
        global $conn;
        $project = (int) $project;
    ...
    public function limitResult(array $result, $userid)
    {
        $finresult = array();
        $userid = (int) $userid;
