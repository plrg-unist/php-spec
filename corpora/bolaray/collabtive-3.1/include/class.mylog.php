...
class mylog
{
    ...
    */
     ...
     * @return bool
     */
    public function add($name, $type, $action, $project)
    {
        global $conn;
        $user = $this->userid;
        $uname = $this->uname;
     ...
     */
    public function getProjectLog($project, $limit = 25, $offset = 0)
    {
        global $conn;
        $project = (int)$project;
        $limit = (int)$limit;
     ...
     */
    public function getUserLog($user, $limit = 25)
    {
        global $conn;
        $user = (int)$user;
        $limit = (int)$limit;
     ...
     * @return array $mylog Latest entries
     */
    public function getLog($limit = 5)
    {
        global $conn;
     ...
     */
    public function formatdate($log, $format = "")
    {
        if (!$format) {
