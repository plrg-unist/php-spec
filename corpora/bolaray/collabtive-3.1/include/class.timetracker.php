...
class timetracker
{
    ...
    */
    public function add($user, $project, $task, $comment, $started, $ended, $startday = "", $endday = "")
    {
        global $conn;
    ...
    * @return bool
    */
    public function edit($id, $task, $comment, $started, $ended)
    {
        global $conn;
    ...
    */
    ...
    public function setPaystatus($paystatus, $id)
    {
        global $conn;
    ...
    */
     ...
     */
    public function getUserTrack($user, $project = 0, $task = 0, $start = 0, $end = 0, $lim = 25, $offset = 0)
    {
        global $conn;
        $user = (int) $user;
        $project = (int) $project;
     ...
     */
    public function getProjectTrack($project, $user = 0, $task = 0, $start = 0, $end = 0, $lim = 25, $offset=0)
    {
        global $conn;
        $project = (int) $project;
        $user = (int) $user;
    ...
    */
    public function getTotalTrackTime(array $track)
    {
        $totaltime = 0;
