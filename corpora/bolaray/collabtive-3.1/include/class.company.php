...
class company
{
     ...
     * @return bool
     */
    public function assign($company, $id)
    {
        global $conn;
     ...
     * @return bool
     */
    public function deassign($company, $id)
    {
        global $conn;
    ...
    public function getProjectCompany($project)
    {
        global $conn;
     ...
     */
    public function getCompanies($lim = 10)
    {
        global $conn;
     ...
     */
    public function getAllCompanies($limit = 25, $offset = 0)
    {
        global $conn;
        $limit = (int)$limit;
        $offset = (int)$offset;
