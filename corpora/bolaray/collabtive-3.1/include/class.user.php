...
class user
{
     ...
     */
    public function add($name, $email, $company, $pass, $locale = "", $tags = "", $rate = 0.0)
    {
        global $conn,$mylog;
        $hash = $this->hash($pass);
     ...
     * @return bool
     */
    public function edit($id, $name, $realname, $email, $tel1, $tel2, $company, $zip, $gender, $url, $address1, $address2, $state, $country, $tags, $locale, $avatar = "", $rate = 0.0)
    {
        global $conn,$mylog;
     ...
     * @return bool
     */
    public function editpass($id, $oldpass, $newpass, $repeatpass)
    {
        global $conn;
        $id = (int) $id;
     ...
     * @return bool
     */
    public function admin_editpass($id, $newpass, $repeatpass)
    {
        global $conn;
        $id = (int) $id;
     ...
     * @return array $users
     */
    public function getOnlinelist($offset = 200)
    {
        global $conn;
