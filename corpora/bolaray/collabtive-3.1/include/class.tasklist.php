...
class tasklist
{
     ...
     * @return bool
     */
    public function add_liste($project, $name, $desc, $access = 0, $milestone = 0)
    {
        global $conn,$mylog;
     ...
     * @return bool
     */
    public function edit_liste($id, $name, $desc, $milestone)
    {
        global $conn,$mylog;
     ...
     * @return bool
     */
    public function close_liste($id, $closeMilestones = true)
    {
        global $conn,$mylog;
        $id = (int) $id;
     ...
     */
    public function getProjectTasklists($project, $status = 1)
    {
        global $conn;
        $project = (int) $project;
        $status = (int) $status;
     ...
     */
    public function getTasksFromList($id, $status = 1)
    {
        global $conn;
        $id = (int) $id;
        $status = (int) $status;
