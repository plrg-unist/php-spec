...
class task
{
     ...
     */
    public function add($start, $end, $title, $text, $list, $project)
    {
        global $conn, $mylog;
        $list = (int)$list;
        $project = (int)$project;
     ...
     * @return bool
     */
    public function edit($id, $start, $end, $title, $text, $list)
    {
        global $conn, $mylog;
        $id = (int)$id;
        $list = (int)$list;
     ...
     * @return bool
     */
    public function assign($task, $id)
    {
        global $conn;
        $task = (int)$task;
        $id = (int)$id;
     ...
     * @return bool
     */
    public function deassign($task, $id)
    {
        global $conn;
        $task = (int)$task;
        $id = (int)$id;
     ...
     */
    public function getProjectTasks($project, $status = 1)
    {
        global $conn;
        $project = (int)$project;
        $status = (int)$status;
     ...
     * @return array $lists Tasks
     */
    public function getAllMyProjectTasks($project, $user = 0, $status = 1)
    {
        global $conn;
        $project = (int)$project;
     ...
     */
    public function countAllProjectTasks($project, $user = 0, $status = 1)
    {
        global $conn;
        $project = (int)$project;
        // If no user is given, use the currently logged in one.
     ...
     * @return array $lists Tasks
     */
    public function getMyTasks($user, $status = 1, $offset = 0, $limit = 15)
    {
        global $conn;
        $limit = (int)$limit;
        $offset = (int)$offset;
     ...
     */
    public function getTodayTasks($month, $year, $day, $project = 0)
    {
        global $conn;
        $month = (int)$month;
        $year = (int)$year;
