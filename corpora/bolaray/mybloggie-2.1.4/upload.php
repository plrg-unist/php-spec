...
if ($level==1 || ($level==2 && $enable_user_upload)) {
    ...
    function thumbnail()
    {
        ...
        if (extension_loaded('gd')) {
            ...
            if (strtolower($ext) == "png") {
                ...
                echo 'Cannot find a suitable output format';
            }
            ...
            echo 'GD-library support is not available';
        }
    ...
    if (!empty($_REQUEST['del']) && $allow_delete) {
        ...
        elseif (strpos($_REQUEST['del'], "files/") === false); //possible hacking
...
<center>
   ...
   <font color="red"><?php if (!empty($_REQUEST['message'])) {
       echo $_REQUEST['message'];
   } ?></font>
   <br><!--action="<?php //echo $_SERVER['PHP_SELF']?>-->
