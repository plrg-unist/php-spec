...
function parsePingbackXML($xmlfile, $start, $end, $cdata)
...
function startPB($parser, $name, $a)
{ /* This function is executed everytime an xml start tag is met. */
...
function PBData($parser, $data)
{ /* This function is executed on all xml content. */
    global $currentTag, $currentId, $pingbacks;
...
function endPB($parser, $name)
{ /* This function is executed everytime an xml end tag is met. */
    global $currentTag, $currentId, $pingbacks;
    $currentTag = "";
}
?>