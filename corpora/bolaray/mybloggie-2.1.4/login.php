...
if(isset($mode)) {
    if($mode == "login") {
        ...
        if($username == "") {
            message($lang['Error'], $lang['Msg_enter_name']);
        }
        if($passwd == "") {
            message($lang['Error'], $lang['Msg_enter_pass']);
        }
...
<link rel="stylesheet" title="<?php echo $style ?>" href="templates/<?php echo $style ?>/<?php echo $style ?>" type="text/css" />
</head>
<body bgcolor="#FFFFFF" topmargin="5" leftmargin="5" marginheight="5" marginwidth="5" ><center>
<?php  message($lang['Error'], $lang['Msg_invalid_pass']) ;  ?>
</body></html>
<?php    } else {
    session_start();
...
<table id="Table_01" width="400"  border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td>
            <img src="templates/<?php echo $style ?>/images/login_01.gif" width="24" height="37" alt=""></td>
        <td>
            <img src="templates/<?php echo $style ?>/images/login_02.gif" width="351" height="37" alt=""></td>
        <td>
            <img src="templates/<?php echo $style ?>/images/login_03.gif" width="25" height="37" alt=""></td>
    </tr>
    <tr>
        <td background="templates/<?php echo $style ?>/images/login_04.gif" width="24" height="300">
            </td>
        <td>
<center>
<table width="300" cellppacing="0" cellpadding="3" border="0">
 ...
 <tr><td colspan=2></td></tr>
<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?mode=login">
<tr>
...
<td height='25'><input type=submit value='Log In' name=submit></td>
 ...
 <tr><td colspan=2></td></tr>
        ...
        <td background="templates/<?php echo $style ?>/images/login_06.gif" width="25" height="300">
            </td>
    </tr>
    <tr>
        <td>
            <img src="templates/<?php echo $style ?>/images/login_07.gif" width="24" height="37" alt=""></td>
        <td>
            <a href="http://mywebland.com"><img src="templates/<?php echo $style ?>/images/login_08.gif" width="351" height="37" alt="" border="0"></a></td>
        <td>
            <img src="templates/<?php echo $style ?>/images/login_09.gif" width="25" height="37" alt=""></td>
    </tr>
</table>
