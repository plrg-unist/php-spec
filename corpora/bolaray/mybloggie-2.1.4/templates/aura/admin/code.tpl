...
//th_help = "Insert auto thumbnail image ): [tmb]http://image_url[/tmb]  (alt+th)";
...
function tag_list()
{
    var listvalue = "init";
    var thelist = "";
    var  list_prompt = "Enter each list followed by 'OK', Press 'Cancel' to end the list";
...
function doInsert(ibTag, ibClsTag, isSingle)
{
    ...
    if ( (clientVer >= 4) && is_ie && is_win) // Ensure it works for IE4up / Win only
    {
