...
if(strlen($_SESSION['doctor_id']==0)) {
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql=mysqli_query($con, "update doctors set specilization='$docspecialization',doctorName='$docname',address='$docaddress',docFees='$docfees',contactno='$doccontactno' where id='".$_SESSION['doctor_id']."'");
        if($sql) {
