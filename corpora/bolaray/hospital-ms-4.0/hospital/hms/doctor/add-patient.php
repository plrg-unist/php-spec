...
if(strlen($_SESSION['doctor_id']==0)) {
    ...
    if(isset($_POST['submit'])) {
        ...
        $patage=$_POST['patage'];
        $medhis=$_POST['medhis'];
        $sql=mysqli_query($con, "insert into tblpatient(Docid,PatientName,PatientContno,PatientEmail,PatientGender,PatientAdd,PatientAge,PatientMedhis) values('$docid','$patname','$patcontact','$email','$gender','$pataddress','$patage','$medhis')");
        if($sql) {
