...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `openemr` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Holds information about api refresh tokens.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Detailed information of each vital_forms observation column';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `jwt_grant_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `jti` (`jti`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Holds JWT authorization grant ids to prevent replay attacks';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lang_constants` (
  ...
  `constant_name` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  UNIQUE KEY `cons_id` (`cons_id`),
  KEY `constant_name` (`constant_name`(100))
) ENGINE=InnoDB AUTO_INCREMENT=13235 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lang_definitions` (
  ...
  KEY `cons_id` (`cons_id`)
) ENGINE=InnoDB AUTO_INCREMENT=234779 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Holds additional data about patient medications.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-07  9:12:02
