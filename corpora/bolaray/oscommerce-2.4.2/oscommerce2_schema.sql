...
--
-- Host: localhost    Database: oscommerce2
-- ------------------------------------------------------
...
--
-- Current Database: `oscommerce2`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `oscommerce2` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `oscommerce2`;

--
-- Table structure for table `osc_action_recorder`
--
...
--
-- Table structure for table `osc_address_format`
--
...
CREATE TABLE `osc_address_format` (
  ...
  `address_summary` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`address_format_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `osc_administrators`
--
...
--
-- Table structure for table `osc_banners`
--
...
CREATE TABLE `osc_banners` (
  ...
  `banners_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `osc_banners_history`
--
...
--
-- Table structure for table `osc_configuration_group`
--
...
CREATE TABLE `osc_configuration_group` (
  ...
  `configuration_group_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `osc_countries`
--
...
--
-- Table structure for table `osc_currencies`
--
...
--
-- Table structure for table `osc_customers`
--
...
CREATE TABLE `osc_customers` (
  ...
  `customers_password` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `osc_customers_basket`
--
...
--
-- Table structure for table `osc_customers_basket_attributes`
--
...
--
-- Table structure for table `osc_customers_info`
--
...
--
-- Table structure for table `osc_geo_zones`
--
...
CREATE TABLE `osc_geo_zones` (
  ...
  `geo_zone_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `osc_languages`
--
...
--
-- Table structure for table `osc_languages_definitions`
--
...
CREATE TABLE `osc_languages_definitions` (
  ...
  `content_group` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `definition_key` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `definition_value` text COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `osc_manufacturers`
--
...
CREATE TABLE `osc_manufacturers` (
  ...
  `manufacturers_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `osc_manufacturers_info`
--
...
CREATE TABLE `osc_manufacturers_info` (
  ...
  `manufacturers_seo_keywords` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `manufacturers_seo_title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`manufacturers_id`,`languages_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `osc_newsletters`
--
...
--
-- Table structure for table `osc_orders`
--
...
CREATE TABLE `osc_orders` (
  ...
  `delivery_street_address` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `osc_orders_products`
--
...
--
-- Table structure for table `osc_orders_products_attributes`
--
...
CREATE TABLE `osc_orders_products_attributes` (
  ...
  `products_options` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `products_options_values` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `osc_orders_products_download`
--
...
--
-- Table structure for table `osc_orders_status`
--
...
CREATE TABLE `osc_orders_status` (
  ...
  `language_id` int(11) NOT NULL DEFAULT '1',
  `orders_status_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `osc_orders_status_history`
--
...
--
-- Table structure for table `osc_orders_total`
--
...
--
-- Table structure for table `osc_products_attributes`
--
...
--
-- Table structure for table `osc_products_attributes_download`
--
...
--
-- Table structure for table `osc_products_images`
--
...
--
-- Table structure for table `osc_products_notifications`
--
...
--
-- Table structure for table `osc_products_options`
--
...
CREATE TABLE `osc_products_options` (
  ...
  `language_id` int(11) NOT NULL DEFAULT '1',
  `products_options_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`products_options_id`,`language_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `osc_products_options_values`
--
...
CREATE TABLE `osc_products_options_values` (
  ...
  `language_id` int(11) NOT NULL DEFAULT '1',
  `products_options_values_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`products_options_values_id`,`language_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `osc_products_options_values_to_products_options`
--
...
--
-- Table structure for table `osc_reviews`
--
...
--
-- Table structure for table `osc_reviews_description`
--

DROP TABLE IF EXISTS `osc_reviews_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `osc_sec_directory_whitelist`
--

DROP TABLE IF EXISTS `osc_sec_directory_whitelist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `osc_sec_directory_whitelist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `osc_sessions`
--
...
CREATE TABLE `osc_sessions` (
  `sesskey` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `osc_specials`
--
...
--
-- Table structure for table `osc_tax_class`
--
...
CREATE TABLE `osc_tax_class` (
  ...
  `tax_class_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `osc_tax_rates`
--
...
--
-- Table structure for table `osc_whos_online`
--
...
--
-- Table structure for table `osc_zones`
--
...
--
-- Table structure for table `osc_zones_to_geo_zones`
--
...
-- Dump completed on 2024-03-07 14:10:04
