          ...
          't.TABLE_COLLATION' => [
            ...
            while ($Qtables->fetch()) {
                ...
                while ($Qfields->fetch()) {
                    ...
                    if (strlen($Qfields->value('Default')) > 0) {
                    ...
                    if (strlen($Qfields->value('Extra')) > 0) {
      ...
      if (isset($_GET['file'])) {
          ...
          if (is_file($backup_directory . $file)) {
              ...
              switch (substr($file, -3)) {
                  case 'zip': $info['compression'] = 'ZIP';
                      break;
                  case '.gz': $info['compression'] = 'GZIP';
                      break;
                  default: $info['compression'] = OSCOM::getDef('text_no_extension');
                      break;
              }
