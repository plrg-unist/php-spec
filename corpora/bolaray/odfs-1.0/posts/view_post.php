            ...
            <div class="card-body">
                <div class="contrain-fluid">
                    ...
                    <div class="list-group comment-list mb-3 rounded-0">
                        <?php
                        $comments = $conn->query("SELECT c.*, u.username, u.avatar FROM `comment_list` c inner join `users` u on c.user_id = u.id where c.post_id ='{$_GET['id']}' order by abs(unix_timestamp(c.date_created)) asc ");
