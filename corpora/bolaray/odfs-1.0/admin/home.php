    ...
    <div class="col-12 col-sm-3 col-md-3">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number">
            <?php
  $qry = $conn->query("SELECT * FROM users where `type` = 2 ");
            echo format_num($qry->num_rows);
?>
            <?php ?>
          </span>
    ...
    <div class="col-12 col-sm-3 col-md-3">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number">
            <?php
            $qry = $conn->query("SELECT * FROM post_list where `status` = 1 and delete_flag = 0 ");
            echo format_num($qry->num_rows);
?>
            <?php ?>
          </span>
    ...
    <div class="col-12 col-sm-3 col-md-3">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number">
            <?php
            $qry = $conn->query("SELECT * FROM post_list where `status` = 0 and delete_flag = 0 ");
            echo format_num($qry->num_rows);
?>
            <?php ?>
          </span>
