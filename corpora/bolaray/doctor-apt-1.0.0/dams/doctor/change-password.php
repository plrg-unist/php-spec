...
if (strlen($_SESSION['damsid']==0)) {
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql ="SELECT ID FROM tbldoctor WHERE ID=:docid and Password=:cpassword";
        ...
        if($query -> rowCount() > 0) {
            $con="update tbldoctor set Password=:newpassword where ID=:docid";
            $chngpwd1 = $dbh->prepare($con);
            $chngpwd1-> bindParam(':docid', $docid, PDO::PARAM_STR);
