...
if (strlen($_SESSION['damsid']==0)) {
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql="update tbldoctor set FullName=:name,MobileNumber=:mobilenumber,Email=:email,Specialization=:sid where ID=:docid";
      ...
      <div class="col-md-12">
        <div class="widget">
          ...
          <div class="widget-body">
            <?php
$docid=$_SESSION['damsid'];
    $sql="SELECT tbldoctor.*,tblspecialization.ID as sid,tblspecialization.Specialization as sssp from  tbldoctor join tblspecialization on tblspecialization.ID=tbldoctor.Specialization where tbldoctor.ID=:docid";
    $query = $dbh -> prepare($sql);
    $query->bindParam(':docid', $docid, PDO::PARAM_STR);
    $query->execute();
