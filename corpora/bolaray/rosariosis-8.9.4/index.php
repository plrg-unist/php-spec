	...
	&& $_REQUEST['modfunc'] === 'first-login' )
{
	...
	if ( HasFirstLoginForm() )
	{
		...
		if ( ! empty( $_POST['first_login'] ) )
		{
            ...
            if (User( 'STAFF_ID' )) {
                $first_login_done = DoFirstLoginForm( $_REQUEST['first_login_s'] , -1)
            }
            else {
                $first_login_done = DoFirstLoginForm(-1, $_REQUEST['first_login']);
            }
		}
...
?>
	...
	<details class="about-rosariosis">
		...
		<p class="center size-1">
			...
			<br />&copy; 2012-2024 <a href="https://www.rosariosis.org" noreferrer>RosarioSIS</a>
		</p>
	</details>
