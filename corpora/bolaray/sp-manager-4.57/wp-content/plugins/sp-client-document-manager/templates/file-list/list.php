...
if ($pid != 0) { ?>
            <div class="sp-cdm-rc-folder sp-cdm-rc-list-item" onclick="sp_cdm_load_project(<?php echo intval($file_list['current_folder']['parent']); ?>)">
            <?php do_action('spdm_file_list_column_before_folder_back'); ?>
            <a href="javascript:sp_cdm_load_project(<?php echo intval($file_list['current_folder']['parent']); ?>)"><img src="<?php echo esc_attr($file_list['back_image']); ?>" width="42"> &laquo; <?php echo __("Go Back", "sp-client-document-manager"); ?></a>
            </div>
            <?php
