...
if(!function_exists('sp_cdm_display_projects')) {
    ...
    function sp_cdm_replace_project_select($pid_selected)
    {
        ...
        if(is_admin() && $_GET['page'] == 'sp-client-document-manager-fileview' && isset($_GET['id'])) {
        ...
        if(isset($_COOKIE['overide_uid']) && current_user_can('sp_cdm_admin_bar') && !is_admin()) {
        ...
        if(count($projects) > 0 or get_option('sp_cu_user_projects') == 1 or get_option('sp_cu_user_projects_required') ==1) {
            ...
            if(get_option('sp_cu_user_projects_required') == 0) {
                ...
                $select_dropdown .='<option name="" selected="selected">' . __("No Folder", "sp-client-document-manager") . '</option>';
            ...
            $select_dropdown =  apply_filters('wpfh_sub_projects', $select_dropdown, $projects[$i]['id'], $uid);
...
';
            ...
            if(get_option('sp_cu_user_projects_required') == 1) {
                ...
                $requird = '';
                $none = '<option value="0" >'.__("None", 'sp-client-document-manager').'</option>';
            }
            if($onlyoptions == false) {
                $select_dropdown .='
	...
	<select name="pid" class="pid_select">';
            ...
            if(get_option('sp_cu_user_projects_required') == 0) {
                ...
                $select_dropdown .='<option name="" selected="selected">'.__("No", "sp-client-document-manager").' '.sp_cdm_folder_name() .'</option>';
            ...
            if(get_option('sp_cu_user_projects') == 1  or current_user_can('manage_options')) {
                ...
                $html .= '<a href="javascript:sp_cu_dialog(\'#sp_cu_add_project\',550,130)" class="button" style="margin-left:15px">' . __(sprintf("Add %s", sp_cdm_folder_name()), "sp-client-document-manager") . '</a>
