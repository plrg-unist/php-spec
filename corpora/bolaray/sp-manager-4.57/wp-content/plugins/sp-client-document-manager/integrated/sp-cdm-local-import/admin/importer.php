...
public function add_folder($name, $pid)
{
    session_start();
    global $wpdb;
...
public function random_hash($filename)
{
...
public function add_file($file, $pid, $uid)
{
    session_start();
    global $wpdb;
...
public function copy_local_files($dir)
{
    session_start();
    $contents = array();
...
public function count_path($path)
{
...
public function process($pid, $uid)
{
    session_start();
...
public function process_old($dir, $pid, $uid)
{
...
public function find_folder_structure($dir)
{
...
public function find_folder_structurezzz($dir)
{
...
public function plotTreeCreate_folders($arr, $indent=0, $mother_run=true, $pid = 0)
{
    if ($mother_run) {
...
public function plotTree($arr, $indent=0, $mother_run=true, $pid = 0)
{
    if ($mother_run) {
        // the beginning of plotTree. We're at rootlevel
        echo "start\n";
...
public function get_folder_structure($dir)
{
...
public function count_local_files($path)
{
    if(is_dir($path)) {
