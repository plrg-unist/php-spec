...
class sp_cdm_media_viewfile
{
    ...
    public function edit_file_save($file_id, $update)
    {
        ...
        if(isset($_POST['embed'])) {
            ...
            add_filter('wp_kses_allowed_html', 'cdm_allow_iframes_filter');
            $update_embed['embed'] =wp_kses_allowed_html($_POST['embed']);
            remove_filter('wp_kses_allowed_html', 'cdm_allow_iframes_filter');
    ...
    public function edit_file($field, $r)
    {
    ...
    public function download_link($link, $r)
    {
    ...
    public function viewfile_delete_button($html, $r)
    {
    ...
    public function video($stream, $ext, $embed = false)
    {
...
.sp_cdm_video_holder iframe {
  ...
  Your browser does not support the video tag.
    ...
    public function whole_view($html, $r)
    {
    ...
    public function file_info_view($html, $r, $info_left_column, $info_right_column)
    {
    ...
    public function tab_name($html, $r)
    {
        $style= get_option('sp_cdm_media_style', 'tab');
        $ext = substr(strrchr($r[0]['file'], '.'), 1);
    ...
    public function tab_content($html, $r)
    {
