...
class cdm_uploader
{
    ...
    public function add_folder()
    {
        ...
        if (cdm_var('page') == 'sp-client-document-manager-fileview') {
            ...
            $add_project .= '<input type="hidden" id="sub_category_uid" name="uid" value="' . apply_filters('sp_cdm/front/user_id', $current_user->ID) . '">';
        }
		...
		' . sp_cdm_folder_name() . ' ' . __("Name", "sp-client-document-manager") . ' <input  id="sub_category_name" type="text" name="project-name"  style="width:200px !important"> 

		<input type="submit" value="' . __("Add", "sp-client-document-manager") . ' ' . sp_cdm_folder_name() . '" name="add-project" onclick="sp_cu_add_project()">
    ...
    public function above_uploader()
    {
    ...
    public function admin_upload_dialog()
    {
    ...
    public function view_file_modal()
    {


        echo  '<div style="display:none"><div class="cdm-modal" data-remodal-options="{ \'hashTracking\': false }" data-remodal-id="file"> <a data-remodal-action="close" class="remodal-close"></a>
