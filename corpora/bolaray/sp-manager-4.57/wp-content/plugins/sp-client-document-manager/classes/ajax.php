...
public function login($vars)
{
    ...
    public function view_file($file_id = false)
    {
...
<strong>' . __("Notes ", "sp-client-document-manager") . ': </strong> ' . stripslashes($r[0]['notes']) . '
  ...
  ';
    ...
    public function remove_cat($id = false)
    {
        global $wpdb, $current_user;
...
';
    ...
    public function sub_folders($id, $main, $zip)
    {
        global $wpdb, $current_user;
   ...
   public static function folder_files($id)
   {
    ...
    public function get_structure($pid, $folder_structure = array())
    {
        global $wpdb, $current_user;
        if (!is_user_logged_in()) {
            exit;
    ...
    public function vendor_replace_vars($message, $post)
    {
