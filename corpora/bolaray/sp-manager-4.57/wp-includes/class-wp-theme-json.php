...
class WP_Theme_JSON
{
     ...
     * @var string[]
     */
    public const VALID_ORIGINS = array(
        'default',
        'blocks',
        'theme',
        'custom',
     ...
     * @var array
     */
    public const PRESETS_METADATA = array(
        array(
     ...
     * @var array
     */
    public const PROPERTIES_METADATA = array(
     ...
     * @var array
     */
    public const INDIRECT_PROPERTIES_METADATA = array(
        'gap'        => array(
     ...
     * @since 5.9.0
     */
    public const PROTECTED_PROPERTIES = array(
     ...
     * @var string[]
     */
    public const VALID_TOP_LEVEL_KEYS = array(
        'customTemplates',
        'description',
        'patterns',
        'settings',
     ...
     * @var array
     */
    public const VALID_SETTINGS = array(
     ...
     * @var array
     */
    public const VALID_STYLES = array(
        'border'     => array(
            'color'  => null,
            'radius' => null,
            'style'  => null,
     ...
     */
    public const VALID_ELEMENT_PSEUDO_SELECTORS = array(
    ...
    public const __EXPERIMENTAL_ELEMENT_CLASS_NAMES = array(
     ...
     * @var string[]
     */
    public const BLOCK_SUPPORT_FEATURE_LEVEL_SELECTORS = array(
     ...
     * @var array
     */
    public const APPEARANCE_TOOLS_OPT_INS = array(
        array( 'border', 'color' ),
        array( 'border', 'radius' ),
        array( 'border', 'style' ),
        array( 'border', 'width' ),
