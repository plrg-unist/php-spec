...
function wp_get_db_schema($scope = 'all', $blog_id = null)
{
 ...
 KEY name (name($max_index_length))
    ...
    $table = "CREATE TABLE $wpdb->term_taxonomy (
 ...
 KEY taxonomy (taxonomy)
    ...
    $table = "CREATE TABLE $wpdb->term_relationships (
 ...
 KEY term_taxonomy_id (term_taxonomy_id)
    ...
    $table = "CREATE TABLE $wpdb->commentmeta (
	meta_id bigint(20) unsigned NOT NULL auto_increment,
    ...
    $table = "CREATE TABLE $wpdb->comments (
    ...
    $blog_tables .= $table;
    $table = "CREATE TABLE $wpdb->options (
    ...
    $table = "CREATE TABLE $wpdb->postmeta (
	meta_id bigint(20) unsigned NOT NULL auto_increment,
    ...
    $table = "CREATE TABLE $wpdb->blogmeta (
	meta_id bigint(20) unsigned NOT NULL auto_increment,
    ...
    $ms_global_tables .= $table;
    $table = "CREATE TABLE $wpdb->registration_log (
    ...
    $ms_global_tables .= $table;
    $table = "CREATE TABLE $wpdb->sitemeta (
    ...
    $ms_global_tables .= $table;
    $table = "CREATE TABLE $wpdb->signups (
